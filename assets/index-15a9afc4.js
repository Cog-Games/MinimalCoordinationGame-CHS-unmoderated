var Ln=Object.defineProperty;var $n=(G,n,e)=>n in G?Ln(G,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):G[n]=e;var xn=(G,n,e)=>($n(G,typeof n!="symbol"?n+"":n,e),e);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function e(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(a){if(a.ep)return;a.ep=!0;const r=e(a);fetch(a.href,r)}})();const K=(G,n)=>{try{return{BASE_URL:"/MinimalCoordinationGame-CHS-unmoderated/",MODE:"production",DEV:!1,PROD:!0,SSR:!1}[G]||n}catch{return console.warn(`Environment variable ${G} not available, using default: ${n}`),n}},Tn=typeof window<"u"&&window.location&&window.location.origin?window.location.origin:"http://localhost:3001",bn="gridworld.rlStudyCondition",vn=()=>Math.random()<.5?"joint":"individual",zn=()=>{const G=String(K("VITE_STUDY_RL_CONDITION","")||"").toLowerCase();if(G==="joint"||G==="individual")return G;try{if(typeof sessionStorage<"u"){const n=sessionStorage.getItem(bn);if(n==="joint"||n==="individual")return n;const e=vn();return sessionStorage.setItem(bn,e),e}}catch{}return vn()},un=zn(),wn=un==="joint"?"rl_joint":"rl_individual",Hn=un==="joint"?"joint":"individual",i={debug:{disableConsoleLogs:K("VITE_DISABLE_DEBUG_LOGS","false")==="true"},server:{url:K("VITE_SERVER_URL",Tn),reconnectAttempts:3,reconnectDelay:1e3,googleAppsScriptUrl:K("VITE_GOOGLE_APPS_SCRIPT_URL","https://script.google.com/macros/s/AKfycbyfQ-XKsoFbmQZGM7c741rEXh2ZUpVK-uUIu9ycooXKnaxM5-hRSzIUhQ-uWZ668Qql/exec"),enableGoogleDriveSave:K("VITE_ENABLE_GOOGLE_DRIVE_SAVE","true")==="true"},game:{name:"GridWorldExperiment",version:"2.0.0",prolificCompletionCode:K("VITE_PROLIFIC_COMPLETION_CODE","CTNDR8GV"),matrixSize:15,maxGameLength:60,studyRLCondition:un,players:{player1:{type:"human",color:"red",description:"Human player (you)"},player2:{type:wn,color:"purple",description:"Human, GPT, or RL partner"}},experiments:{order:["1P1G","1P2G","2P2G","2P3G"],numTrials:{"1P1G":2,"1P2G":8,"2P2G":4,"2P3G":8}},successThreshold:{enabled:!1,consecutiveSuccessesRequired:5,minTrialsBeforeCheck:12,maxTrials:24,randomSamplingAfterTrial:12},timing:{trialToFeedbackDelay:500,feedbackDisplayDuration:1e3,preTrialDisplayDuration:2e3,fixationDuration:1e3,newGoalMessageDuration:0,maxTrialDurationMs:60*1e3,waitingForPartnerMinDuration:9*1e3,waitingForPartnerMaxDuration:9*1e3},agent:{type:Hn,delay:500,independentDelay:300,synchronizedMoves:!0,gpt:{model:"gpt",temperature:0,memory:{enabled:!0,maxSteps:50}}}},visual:{canvasSize:632,cellSize:40,padding:2,colors:{background:"#ffffff",grid:"#cccccc",player1:"#ff0000",player2:"#8000ff",goal:"#0066ff",obstacle:"#333333"}},tts:{useOpenAI:K("VITE_USE_OPENAI_TTS","true")==="true",openAIVoice:K("VITE_OPENAI_TTS_VOICE","nova"),ttsServerUrl:K("VITE_TTS_SERVER_URL",Tn),useCustomAudio:K("VITE_USE_CUSTOM_AUDIO","true")==="true",customAudioPath:K("VITE_CUSTOM_AUDIO_PATH","/audio/questionnaire/")},oneP2G:{minStepsBeforeNewGoal:1,distanceConditions:{CLOSER_TO_PLAYER1:"closer_to_player1",FARTHER_TO_PLAYER1:"farther_to_player1",EQUAL_TO_PLAYER1:"equal_to_player1",NO_NEW_GOAL:"no_new_goal"},distanceConstraint:{closerThreshold:2,fartherThreshold:2,equalTolerance:!1,allowEqualDistance:!1},goalConstraints:{minDistanceFromHuman:1,maxDistanceFromHuman:12,minDistanceBetweenGoals:3,avoidRectangleArea:!1,blockPathCheck:!1}},twoP3G:{minStepsBeforeNewGoal:1,newGoalMessageDuration:5e3,distanceConditions:{CLOSER_TO_PLAYER2:"closer_to_player2",CLOSER_TO_PLAYER1:"closer_to_player1",EQUAL_TO_BOTH:"equal_to_both",NO_NEW_GOAL:"no_new_goal"},distanceConstraint:{closerThreshold:2,allowEqualDistance:!1,maxDistanceIncrease:5},goalConstraints:{minDistanceFromHuman:1,maxDistanceFromHuman:12,avoidRectangleArea:!1,maintainDistanceSum:!1,blockPathCheck:!1}},multiplayer:{maxWaitTime:6e4,roomTimeout:3e5,reconnectAttempts:3,syncInterval:100,moveTimeout:1e4,synchronizedHumanTurns:!1,matchPlayReadyTimeout:1e4,fallbackAIType:wn,inactivityFallback:{enabled:!0,timeoutMs:4e4,checkIntervalMs:5e3},realTimeMovement:{moveThrottleDelay:100,immediateLocalUpdates:!0,stateSyncInterval:300,moveValidationTimeout:1e3,localMoveProtectionWindow:300}}},z={blank:0,player:1,ai_player:2,goal:3,obstacle:4},on={arrowup:{movement:[-1,0],name:"up"},arrowdown:{movement:[1,0],name:"down"},arrowleft:{movement:[0,-1],name:"left"},arrowright:{movement:[0,1],name:"right"}};(()=>{var G;try{if((G=i==null?void 0:i.debug)==null?void 0:G.disableConsoleLogs){const e=()=>{};typeof console<"u"&&(console.log=e,console.info=e,console.debug=e)}}catch{}})();const U={setPlayerType(G,n){const e=n==="ai"?"rl_joint":n;["human","gpt","rl_individual","rl_joint"].includes(e)&&(i.game.players[`player${G}`].type=e,G===2&&(e==="rl_joint"&&(i.game.agent.type="joint",i.game.studyRLCondition="joint"),e==="rl_individual"&&(i.game.agent.type="individual",i.game.studyRLCondition="individual")))},getPlayerType(G){return i.game.players[`player${G}`].type},isHumanAIMode(){return i.game.players.player2.type!=="human"},isHumanHumanMode(){return i.game.players.player2.type==="human"},setExperimentOrder(G){i.game.experiments.order=G},getNumTrials(G){return i.game.experiments.numTrials[G]||12},isSynchronizedHumanTurnsEnabled(G){var n;try{return String(G||"").toUpperCase().includes("2P")&&!!((n=i==null?void 0:i.multiplayer)!=null&&n.synchronizedHumanTurns)}catch{return!1}}},Sn=window.io;class jn{constructor(){this.socket=null,this.isConnected=!1,this.eventHandlers=new Map,this.reconnectAttempts=0,this.maxReconnectAttempts=i.server.reconnectAttempts}async connect(){return new Promise((n,e)=>{if(!Sn){e(new Error("Socket.IO not available. Please ensure the Socket.IO client is loaded."));return}this.socket=Sn(i.server.url,{transports:["websocket"],upgrade:!1}),this.socket.on("connect",()=>{console.log("Connected to server"),this.isConnected=!0,this.reconnectAttempts=0,n()}),this.socket.on("disconnect",t=>{console.log("Disconnected from server:",t),this.isConnected=!1,this.emit("disconnect",t),t!=="io server disconnect"&&this.handleReconnection()}),this.socket.on("connect_error",t=>{console.error("Connection error:",t),this.isConnected=!1,this.reconnectAttempts===0&&e(t)}),this.setupEventForwarding(),setTimeout(()=>{this.isConnected||e(new Error("Connection timeout"))},1e4)})}setupEventForwarding(){["room-joined","player-joined","room-full","player-disconnected","player-ready-status","match-play-ready-status","game-started","player-action","game-state-update","trial-completed","experiment-completed","chat-message","error"].forEach(e=>{this.socket.on(e,t=>{this.emit(e,t)})})}handleReconnection(){this.reconnectAttempts<this.maxReconnectAttempts?(this.reconnectAttempts++,console.log(`Attempting to reconnect (${this.reconnectAttempts}/${this.maxReconnectAttempts})`),this.emit("reconnecting",{attempt:this.reconnectAttempts,maxAttempts:this.maxReconnectAttempts}),setTimeout(()=>{this.socket.connect()},i.server.reconnectDelay*this.reconnectAttempts)):(console.error("Max reconnection attempts reached"),this.emit("error",{message:"Connection lost. Please refresh the page or try reconnecting.",type:"connection_lost",canRetry:!0}))}async retryConnection(){if(this.socket&&!this.isConnected){console.log("Manually retrying connection..."),this.reconnectAttempts=0;try{return await this.connect(),!0}catch(n){return console.error("Manual reconnection failed:",n),!1}}return!1}async joinRoom(n={}){return new Promise((e,t)=>{const a=setTimeout(()=>{t(new Error("Join room timeout"))},1e4);this.socket.once("room-joined",r=>{clearTimeout(a),e(r)}),this.socket.once("error",r=>{clearTimeout(a),t(r)}),this.socket.emit("join-room",n)})}setPlayerReady(){this.isConnected&&this.socket.emit("player-ready")}setMatchPlayReady(){this.isConnected&&this.socket.emit("match-play-ready")}sendGameAction(n){this.isConnected&&this.socket.emit("game-action",{action:n})}syncGameState(n){this.isConnected&&this.socket.emit("sync-game-state",n)}sendTrialComplete(n){this.isConnected&&this.socket.emit("trial-complete",n)}sendExperimentComplete(n){this.isConnected&&this.socket.emit("experiment-complete",n)}sendChatMessage(n){this.isConnected&&this.socket.emit("chat-message",n)}on(n,e){this.eventHandlers.has(n)||this.eventHandlers.set(n,[]),this.eventHandlers.get(n).push(e)}off(n,e){if(this.eventHandlers.has(n)){const t=this.eventHandlers.get(n),a=t.indexOf(e);a>-1&&t.splice(a,1)}}emit(n,e){this.eventHandlers.has(n)&&this.eventHandlers.get(n).forEach(t=>{try{t(e)}catch(a){console.error(`Error in event handler for ${n}:`,a)}})}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null),this.isConnected=!1}}const A={isValidPosition(G){if(!G||!Array.isArray(G)||G.length<2)return!1;const[n,e]=G;return n>=0&&n<i.game.matrixSize&&e>=0&&e<i.game.matrixSize},isValidMove(G,n,e){const t=this.transition(n,e);if(!this.isValidPosition(t))return[0,0];const[a,r]=t;return G[a][r]===z.obstacle?[0,0]:e},transition(G,n){const[e,t]=G;return[e+n[0],t+n[1]]},calculateGridDistance(G,n){return!G||!n||!Array.isArray(G)||!Array.isArray(n)||G.length<2||n.length<2?1/0:Math.abs(G[0]-n[0])+Math.abs(G[1]-n[1])},isGoalReached(G,n){if(!G||!n||!Array.isArray(n))return!1;for(let e=0;e<n.length;e++)if(G[0]===n[e][0]&&G[1]===n[e][1])return!0;return!1},whichGoalReached(G,n){for(let e=0;e<n.length;e++)if(this.isGoalReached(G,[n[e]]))return e;return null},detectPlayerGoal(G,n,e,t){if(!n)return null;let a;if(typeof n=="string")switch(n){case"up":a=[-1,0];break;case"down":a=[1,0];break;case"left":a=[0,-1];break;case"right":a=[0,1];break;default:return null}else if(Array.isArray(n))a=n;else return null;if(a[0]===0&&a[1]===0)return null;const r=this.transition(G,a);let o=1/0,s=null;const l=[];for(let c=0;c<e.length;c++){const p=this.calculateGridDistance(r,e[c]);p<o?(o=p,s=c,l.length=0,l.push(c)):p===o&&l.push(c)}return l.length>1?t&&t.length>0?t[t.length-1]:null:s},updateMatrix(G,n,e,t){const a=G.map(r=>[...r]);return n>=0&&n<a.length&&e>=0&&e<a[0].length&&(a[n][e]=t),a},generateRandomPosition(G=[]){const n=i.game.matrixSize;let e,t=0;const a=100;do e=[Math.floor(Math.random()*n),Math.floor(Math.random()*n)],t++;while(t<a&&G.some(r=>r[0]===e[0]&&r[1]===e[1]));return e},createFallbackDesign(G){switch(console.log("Creating fallback design for:",G),G){case"1P1G":return{initPlayerGrid:[7,2],target1:[7,12],mapType:"1P1G"};case"1P2G":return{initPlayerGrid:[7,7],target1:[2,7],target2:[12,7],mapType:"1P2G"};case"2P2G":return{initPlayerGrid:[7,2],initAIGrid:[7,12],target1:[2,7],target2:[12,7],mapType:"2P2G"};case"2P3G":return{initPlayerGrid:[7,2],initAIGrid:[7,12],target1:[2,7],target2:[12,7],mapType:"2P3G"};default:return console.error("No fallback design for experiment type:",G),null}},calculateSuccessRate(G){if(!G||G.length===0)return 0;const n=G.filter(e=>e.collaborationSucceeded===!0||e.completed===!0).length;return Math.round(n/G.length*100)},formatDuration(G){const n=Math.floor(G/1e3),e=Math.floor(n/60),t=n%60;return e>0?`${e}:${t.toString().padStart(2,"0")}`:`${t}s`},deepClone(G){if(G===null||typeof G!="object")return G;if(G instanceof Date)return new Date(G);if(G instanceof Array)return G.map(n=>this.deepClone(n));if(typeof G=="object"){const n={};for(const e in G)G.hasOwnProperty(e)&&(n[e]=this.deepClone(G[e]));return n}}};class Bn{constructor(){this.currentState=null,this.trialData=null,this.experimentData=null,this.isMoving=!1,this.gameStartTime=0,this.stepCount=0,this.conditionSequences={},this.lastMoveTime=new Map,this.lastLocalMoveTime=new Map,this.moveCounter=0,this.lastSyncTime=0,this.syncPending=!1,this.reset()}reset(){this.currentState={gridMatrix:null,player1:null,player2:null,currentGoals:[],experimentType:null,trialIndex:0,gameMode:"human-ai"},this.clearRealTimeSync(),this.trialData={trialIndex:0,experimentType:null,partnerAgentType:null,distanceCondition:null,gptErrorEvents:[],player1Trajectory:[],player2Trajectory:[],player1Actions:[],player2Actions:[],player1RT:[],player2RT:[],aiInferredOtherGoals:[],currentPlayerIndex:[],player1StartPosition:null,player2StartPosition:null,initialGoalPositions:[],trialStartTime:0,player1GoalReachedStep:-1,player2GoalReachedStep:-1,player1CurrentGoal:[],player2CurrentGoal:[],player1FirstDetectedGoal:null,player2FirstDetectedGoal:null,player1FinalReachedGoal:null,player2FinalReachedGoal:null,firstDetectedSharedGoal:null,newGoalPresentedTime:null,newGoalPosition:null,newGoalConditionType:null,newGoalPresented:!1,isNewGoalCloserToPlayer2:null,collaborationSucceeded:void 0,partnerFallbackOccurred:!1,partnerFallbackReason:null,partnerFallbackStage:null,partnerFallbackTime:null,partnerFallbackAIType:null,humanPlayerIndex:null,aiPlayerIndex:null},this.experimentData={allTrialsData:[],currentExperiment:null,successThreshold:{consecutiveSuccesses:0,totalTrialsCompleted:0,experimentEndedEarly:!1,lastSuccessTrial:-1,successHistory:[]},fallbackEvents:[]},this.stepCount=0,this.gameStartTime=0,this.isMoving=!1,this.conditionSequences={}}initializeTrial(n,e,t){var a,r,o,s,l,c,p,d;this.trialData.trialIndex=n,this.trialData.experimentType=e,this.trialData.partnerAgentType=this.getPartnerAgentType(e),this.trialData.trialStartTime=Date.now(),this.gameStartTime=Date.now(),this.stepCount=0,this.isMoving=!1,this.trialData.player1Trajectory=[],this.trialData.player2Trajectory=[],this.trialData.player1Actions=[],this.trialData.player2Actions=[],this.trialData.player1RT=[],this.trialData.player2RT=[],this.trialData.currentPlayerIndex=[],this.trialData.gptErrorEvents=[],this.trialData.player1StartPosition=null,this.trialData.player2StartPosition=null,this.trialData.initialGoalPositions=[],this.trialData.player1CurrentGoal=[],this.trialData.player2CurrentGoal=[],this.trialData.player1FirstDetectedGoal=null,this.trialData.player2FirstDetectedGoal=null,this.trialData.player1FinalReachedGoal=null,this.trialData.player2FinalReachedGoal=null,this.trialData.firstDetectedSharedGoal=null,this.trialData.player1GoalReachedStep=-1,this.trialData.player2GoalReachedStep=-1,this.trialData.newGoalPresentedTime=null,this.trialData.newGoalPosition=null,this.trialData.newGoalConditionType=null,this.trialData.distanceCondition=null,this.trialData.newGoalPresented=!1,this.trialData.isNewGoalCloserToPlayer2=null,this.trialData.collaborationSucceeded=void 0,this.trialData._finalized=!1,this.trialData.partnerFallbackOccurred=!1,this.trialData.partnerFallbackReason=null,this.trialData.partnerFallbackStage=null,this.trialData.partnerFallbackTime=null;try{if(String(e||"").includes("2P")){const g=(o=(r=(a=i==null?void 0:i.game)==null?void 0:a.players)==null?void 0:r.player1)==null?void 0:o.type,f=(c=(l=(s=i==null?void 0:i.game)==null?void 0:s.players)==null?void 0:l.player2)==null?void 0:c.type;g==="human"&&f!=="human"?(this.trialData.humanPlayerIndex=0,this.trialData.aiPlayerIndex=1):f==="human"&&g!=="human"?(this.trialData.humanPlayerIndex=1,this.trialData.aiPlayerIndex=0):(this.trialData.humanPlayerIndex=null,this.trialData.aiPlayerIndex=null)}else this.trialData.humanPlayerIndex=0,this.trialData.aiPlayerIndex=null}catch{}if(e==="2P3G"){const g=this.getRandomDistanceConditionFor2P3G(n);this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}else if(e==="1P2G"){const g=this.getRandomDistanceConditionFor1P2G(n);this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}else if(e==="2P2G"){const g=(d=(p=i==null?void 0:i.twoP3G)==null?void 0:p.distanceConditions)==null?void 0:d.NO_NEW_GOAL;this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}(e==="1P2G"||e==="2P3G")&&(console.log(`🗺️ Starting ${e} trial ${n}: new-goal condition =`,this.trialData.distanceCondition),console.log(`🤝 Partner agent type: ${this.trialData.partnerAgentType}`)),this.setupGridMatrix(t,e),this.currentState.experimentType=e,this.currentState.trialIndex=n;try{this.trialData.player1StartPosition=Array.isArray(this.currentState.player1)&&this.currentState.player1.length>=2?[...this.currentState.player1]:null,this.trialData.player2StartPosition=Array.isArray(this.currentState.player2)&&this.currentState.player2.length>=2?[...this.currentState.player2]:null,Array.isArray(this.currentState.currentGoals)?this.trialData.initialGoalPositions=this.currentState.currentGoals.filter(g=>Array.isArray(g)&&g.length>=2).map(g=>[...g]):this.trialData.initialGoalPositions=[]}catch{}}recordPartnerFallback({reason:n="disconnect",stage:e="in-game",at:t=Date.now(),fallbackAIType:a=null}={}){var r,o,s,l,c,p,d,g,f,h,m,y,T;try{let u="unknown";if(a)u=this.normalizeAITypeName(a);else try{const x=(s=(o=(r=i==null?void 0:i.game)==null?void 0:r.players)==null?void 0:o.player1)==null?void 0:s.type,P=(p=(c=(l=i==null?void 0:i.game)==null?void 0:l.players)==null?void 0:c.player2)==null?void 0:p.type,b=x!=="human"?x:P!=="human"?P:null;if(b==="gpt"){const w=(f=(g=(d=i==null?void 0:i.game)==null?void 0:d.agent)==null?void 0:g.gpt)==null?void 0:f.model;w&&String(w).trim().length>0?u=String(w):(console.warn("⚠️ GPT model not cached in CONFIG for fallback recording, using configured default"),u="gpt-4o")}else if(b==="rl_joint")u="joint-rl";else if(b==="rl_individual")u="individual-rl";else if(b==="ai")u=((m=(h=i==null?void 0:i.game)==null?void 0:h.agent)==null?void 0:m.type)==="individual"?"individual-rl":"joint-rl";else if(b&&b!=="human")u=String(b);else{const w=((y=i==null?void 0:i.multiplayer)==null?void 0:y.fallbackAIType)||"rl_joint";u=this.normalizeAITypeName(w)}}catch{const P=((T=i==null?void 0:i.multiplayer)==null?void 0:T.fallbackAIType)||"rl_joint";u=this.normalizeAITypeName(P)}if(this.trialData&&(this.trialData.partnerFallbackOccurred=!0,this.trialData.partnerFallbackReason=n,this.trialData.partnerFallbackStage=e,this.trialData.partnerFallbackTime=t,this.trialData.partnerFallbackAIType=u),this.experimentData){const x=this.currentState&&Number.isInteger(this.currentState.trialIndex)?this.currentState.trialIndex:-1,P=this.currentState&&this.currentState.experimentType||null,b={reason:n,stage:e,at:t,trialIndex:x,experimentType:P,aiType:u};Array.isArray(this.experimentData.fallbackEvents)?this.experimentData.fallbackEvents.push(b):this.experimentData.fallbackEvents=[b]}}catch{}}recordGptErrorEvent({phase:n="independent",error:e="",humanDirection:t=null,fallback:a=null,fallbackDirection:r=null}={}){try{const o={step:this.stepCount,timeMs:Date.now()-(this.gameStartTime||Date.now()),phase:n,error:String(e||""),humanDirection:t||null,fallback:a||null,fallbackDirection:r||null};Array.isArray(this.trialData.gptErrorEvents)?this.trialData.gptErrorEvents.push(o):this.trialData.gptErrorEvents=[o]}catch{}}setupGridMatrix(n,e){if(!n){console.error("Invalid design provided to setupGridMatrix:",n);return}const t=i.game.matrixSize;if(this.currentState.gridMatrix=Array(t).fill(0).map(()=>Array(t).fill(0)),n.initPlayerGrid&&n.initPlayerGrid.length>=2){const[a,r]=n.initPlayerGrid;this.currentState.gridMatrix[a][r]=z.player,this.currentState.player1=[a,r]}if(e&&e.includes("2P")&&n.initAIGrid&&n.initAIGrid.length>=2){const[a,r]=n.initAIGrid;this.currentState.gridMatrix[a][r]=z.ai_player,this.currentState.player2=[a,r]}else this.currentState.player2=null;if(this.currentState.currentGoals=[],n.target1&&n.target1.length>=2){const[a,r]=n.target1;this.currentState.gridMatrix[a][r]=z.goal,this.currentState.currentGoals.push([a,r])}if(n.target2&&n.target2.length>=2){const[a,r]=n.target2;this.currentState.gridMatrix[a][r]=z.goal,this.currentState.currentGoals.push([a,r])}}addGoal(n){if(!n||n.length<2)return;const[e,t]=n;if(!(!this.currentState||!this.currentState.gridMatrix)&&!(e<0||e>=this.currentState.gridMatrix.length)&&!(t<0||t>=this.currentState.gridMatrix[0].length)){if(this.currentState.currentGoals.some(a=>a[0]===e&&a[1]===t)){console.log(`🔧 [GOAL] Duplicate goal at [${e}, ${t}] not added`);return}console.log(`🎯 [GOAL] Adding goal at [${e}, ${t}]. Total goals: ${this.currentState.currentGoals.length+1}`),this.currentState.gridMatrix[e][t]=z.goal,this.currentState.currentGoals.push([e,t])}}markNewGoalPresented(n,e,t={}){if(!this.trialData)return;this.trialData.newGoalPresented=!0,this.trialData.newGoalPresentedTime=this.stepCount,this.trialData.newGoalPosition=n?[...n]:null;const a=e||this.trialData.newGoalConditionType||this.trialData.distanceCondition||null;this.trialData.newGoalConditionType=a,this.trialData.distanceCondition=a,this.currentState&&(this.currentState.newGoalConditionType=a,this.currentState.distanceCondition=a),typeof t.isNewGoalCloserToPlayer2=="boolean"&&(this.trialData.isNewGoalCloserToPlayer2=t.isNewGoalCloserToPlayer2)}processPlayerMove(n,e,t=null){var r;if(this.isMoving)return{success:!1,reason:"already_moving"};const a=n===1?this.currentState.player1:this.currentState.player2;if(!a)return{success:!1,reason:"invalid_player"};if(A.isGoalReached(a,this.currentState.currentGoals))return{success:!1,reason:"already_at_goal"};this.isMoving=!0;try{const o=(r=on[`arrow${e}`])==null?void 0:r.movement;if(!o)return{success:!1,reason:"invalid_direction"};(this.gameStartTime===0||Date.now()-this.gameStartTime>6e4)&&(console.warn("Invalid gameStartTime detected, resetting to current time"),this.gameStartTime=Date.now());const s=Date.now()-this.gameStartTime;this.recordPlayerMove(n,o,s,t);const l=A.isValidMove(this.currentState.gridMatrix,a,o),c=A.transition(a,l);return this.updatePlayerPosition(n,a,c),this.detectAndRecordGoals(n,o),this.stepCount++,{success:!0,trialComplete:this.checkTrialCompletion(),newPosition:c,stepCount:this.stepCount}}finally{setTimeout(()=>{this.isMoving=!1},100)}}processSynchronizedMoves(n,e){var t,a;if(this.isMoving)return{success:!1,reason:"already_moving"};this.isMoving=!0;try{const r={success:!0,trialComplete:!1},o=this.currentState.player1,s=this.currentState.player2,l=n?(t=on[`arrow${n}`])==null?void 0:t.movement:null,c=e?(a=on[`arrow${e}`])==null?void 0:a.movement:null,p=Date.now()-this.gameStartTime;let d=o;if(o&&l&&!A.isGoalReached(o,this.currentState.currentGoals)){this.recordPlayerMove(1,l,p);const f=A.isValidMove(this.currentState.gridMatrix,o,l);d=A.transition(o,f)}let g=s;if(s&&c&&!A.isGoalReached(s,this.currentState.currentGoals)){this.recordPlayerMove(2,c,p);const f=A.isValidMove(this.currentState.gridMatrix,s,c);g=A.transition(s,f)}return o&&d&&d!==o&&this.updatePlayerPosition(1,o,d),s&&g&&g!==s&&this.updatePlayerPosition(2,s,g),o&&l&&this.detectAndRecordGoals(1,l),s&&c&&this.detectAndRecordGoals(2,c),this.stepCount++,r.trialComplete=this.checkTrialCompletion(),r.newPositions={player1:d,player2:g},r}finally{setTimeout(()=>{this.isMoving=!1},100)}}processSynchronizedMovesMapped(n,e,t){var a,r;if(this.isMoving)return{success:!1,reason:"already_moving"};this.isMoving=!0;try{const o={success:!0,trialComplete:!1},s=this.currentState.player1,l=this.currentState.player2,c=e?(a=on[`arrow${e}`])==null?void 0:a.movement:null,p=t?(r=on[`arrow${t}`])==null?void 0:r.movement:null,d=n===1?c:p,g=n===2?c:p,f=Date.now()-this.gameStartTime;let h=s;if(s&&d&&!A.isGoalReached(s,this.currentState.currentGoals)){this.recordPlayerMove(1,d,f);const y=A.isValidMove(this.currentState.gridMatrix,s,d);h=A.transition(s,y)}let m=l;if(l&&g&&!A.isGoalReached(l,this.currentState.currentGoals)){this.recordPlayerMove(2,g,f);const y=A.isValidMove(this.currentState.gridMatrix,l,g);m=A.transition(l,y)}return s&&h&&h!==s&&this.updatePlayerPosition(1,s,h),l&&m&&m!==l&&this.updatePlayerPosition(2,l,m),s&&d&&this.detectAndRecordGoals(1,d),l&&g&&this.detectAndRecordGoals(2,g),this.stepCount++,o.trialComplete=this.checkTrialCompletion(),o}finally{setTimeout(()=>{this.isMoving=!1},100)}}updatePlayerPosition(n,e,t){const a=n===1?z.player:z.ai_player;this.currentState.gridMatrix[e[0]][e[1]]=z.blank,this.currentState.gridMatrix[t[0]][t[1]]=a,n===1?this.currentState.player1=[...t]:this.currentState.player2=[...t]}recordPlayerMove(n,e,t,a=null){const r=n===1?this.currentState.player1:this.currentState.player2;n===1?(this.trialData.player1Actions.push(e),this.trialData.player1Trajectory.push([...r]),this.trialData.player1RT.push(t)):(this.trialData.player2Actions.push(e),this.trialData.player2Trajectory.push([...r]),this.trialData.player2RT.push(t)),a!==null?this.trialData.currentPlayerIndex.push(a):this.trialData.currentPlayerIndex.push(n===1?0:1)}recordAIInferredOtherGoal(n){try{Array.isArray(this.trialData.aiInferredOtherGoals)||(this.trialData.aiInferredOtherGoals=[]),this.trialData.aiInferredOtherGoals.push(Array.isArray(n)&&n.length>=2?[n[0],n[1]]:null)}catch{}}detectAndRecordGoals(n,e){const t=n===1?this.currentState.player1:this.currentState.player2,a=n===1?this.trialData.player1CurrentGoal:this.trialData.player2CurrentGoal,r=A.detectPlayerGoal(t,e,this.currentState.currentGoals,a);if(n===1?(this.trialData.player1CurrentGoal.push(r),r!==null&&this.trialData.player1FirstDetectedGoal===null&&(this.trialData.player1FirstDetectedGoal=r)):(this.trialData.player2CurrentGoal.push(r),r!==null&&this.trialData.player2FirstDetectedGoal===null&&(this.trialData.player2FirstDetectedGoal=r)),this.currentState.experimentType==="2P3G"&&this.trialData.player1CurrentGoal.length>0&&this.trialData.player2CurrentGoal.length>0){const o=this.trialData.player1CurrentGoal[this.trialData.player1CurrentGoal.length-1],s=this.trialData.player2CurrentGoal[this.trialData.player2CurrentGoal.length-1];o!==null&&s!==null&&o===s&&this.trialData.firstDetectedSharedGoal===null&&(this.trialData.firstDetectedSharedGoal=o)}}checkTrialCompletion(){const n=A.isGoalReached(this.currentState.player1,this.currentState.currentGoals),e=this.currentState.player2?A.isGoalReached(this.currentState.player2,this.currentState.currentGoals):!0;if(n&&this.trialData.player1GoalReachedStep===-1&&(this.trialData.player1GoalReachedStep=this.stepCount,this.trialData.player1FinalReachedGoal=A.whichGoalReached(this.currentState.player1,this.currentState.currentGoals)),this.currentState.player2&&e&&this.trialData.player2GoalReachedStep===-1&&(this.trialData.player2GoalReachedStep=this.stepCount,this.trialData.player2FinalReachedGoal=A.whichGoalReached(this.currentState.player2,this.currentState.currentGoals)),this.currentState.experimentType.startsWith("1P"))return n;if(n&&e){const t=this.trialData.player1FinalReachedGoal,a=this.trialData.player2FinalReachedGoal;return this.trialData.collaborationSucceeded=t===a&&t!==null,!0}return this.stepCount>=i.game.maxGameLength}finalizeTrial(n){var e,t,a,r;if(this.trialData._finalized){console.warn("Trial already finalized, skipping duplicate finalization");return}try{this.currentState&&typeof this.currentState.experimentType=="string"&&this.currentState.experimentType.includes("2P")&&typeof this.trialData.collaborationSucceeded!="boolean"&&(this.trialData.collaborationSucceeded=!1)}catch{}this.trialData.completed=!!n,this.trialData.endTime=Date.now(),this.trialData.totalSteps=this.stepCount;try{if(this.currentState&&String(this.currentState.experimentType||"").includes("2P")){const s=String(this.trialData.partnerAgentType||"").trim(),l=this.getPartnerAgentType(this.currentState.experimentType);l&&s!==l&&(this.trialData.partnerAgentType=l);const c=(a=(t=(e=i==null?void 0:i.game)==null?void 0:e.agent)==null?void 0:t.gpt)==null?void 0:a.model;this.trialData.partnerFallbackOccurred&&c&&/^gpt$/i.test(String(this.trialData.partnerFallbackAIType||""))&&(this.trialData.partnerFallbackAIType=c)}}catch{}try{if(this.trialData.newGoalPresented&&(!this.trialData.newGoalPosition||this.trialData.newGoalPosition.length<2)){const o=Array.isArray((r=this.currentState)==null?void 0:r.currentGoals)?this.currentState.currentGoals:[];if(o.length>=3){const s=o[o.length-1];Array.isArray(s)&&s.length>=2&&(this.trialData.newGoalPosition=[s[0],s[1]])}}}catch{}this.fixMissingGoalValues(),this.experimentData.allTrialsData.push({...this.trialData}),this.trialData._finalized=!0,this.updateSuccessThreshold(n)}fixMissingGoalValues(){var e;const n=((e=this.currentState)==null?void 0:e.experimentType)||"";n.startsWith("1P")?this.trialData.player2FinalReachedGoal=-1:n.startsWith("2P")&&(this.trialData.player1GoalReachedStep===-1&&this.trialData.player1FinalReachedGoal===null&&(this.trialData.player1FinalReachedGoal=-1),this.trialData.player2GoalReachedStep===-1&&this.trialData.player2FinalReachedGoal===null&&(this.trialData.player2FinalReachedGoal=-1))}normalizeAITypeName(n){var t,a,r,o,s,l,c,p,d;if(!n||typeof n!="string")return"unknown";switch(n.toLowerCase().trim()){case"gpt":const g=(r=(a=(t=i==null?void 0:i.game)==null?void 0:t.agent)==null?void 0:a.gpt)==null?void 0:r.model;return g&&String(g).trim()?String(g):"gpt-4o";case"rl_joint":case"joint":return"joint-rl";case"rl_individual":case"individual":return"individual-rl";case"ai":return((s=(o=i==null?void 0:i.game)==null?void 0:o.agent)==null?void 0:s.type)==="individual"?"individual-rl":"joint-rl";case"human":console.error('❌ BUG: Attempted to set partnerFallbackAIType to "human" - using default instead');const f=((l=i==null?void 0:i.multiplayer)==null?void 0:l.fallbackAIType)||"rl_joint";if(f==="rl_joint")return"joint-rl";if(f==="rl_individual")return"individual-rl";if(f==="gpt"){const h=(d=(p=(c=i==null?void 0:i.game)==null?void 0:c.agent)==null?void 0:p.gpt)==null?void 0:d.model;return h&&String(h).trim()?String(h):"gpt-4o"}return"joint-rl";default:return n}}updateSuccessThreshold(n){const e=this.experimentData.successThreshold;e.totalTrialsCompleted++,e.successHistory.push(n),n?(e.consecutiveSuccesses++,e.lastSuccessTrial=e.totalTrialsCompleted-1):e.consecutiveSuccesses=0,e.consecutiveSuccesses>=i.game.successThreshold.consecutiveSuccessesRequired&&e.totalTrialsCompleted>=i.game.successThreshold.minTrialsBeforeCheck&&(e.experimentEndedEarly=!0)}getPartnerAgentType(n){var e,t,a,r,o,s,l,c,p,d,g;try{if(!String(n||"").includes("2P"))return"none";const f=(a=(t=(e=i==null?void 0:i.game)==null?void 0:e.players)==null?void 0:t.player1)==null?void 0:a.type,h=(s=(o=(r=i==null?void 0:i.game)==null?void 0:r.players)==null?void 0:o.player2)==null?void 0:s.type,m=f!=="human"?f:h!=="human"?h:"human";if(m==="human")return"human";if(m==="gpt"){const y=(p=(c=(l=i==null?void 0:i.game)==null?void 0:l.agent)==null?void 0:c.gpt)==null?void 0:p.model;return y&&String(y).trim().length>0?String(y):(console.warn("⚠️ GPT model not cached in CONFIG, using fallback logic"),"gpt-4o")}return m==="rl_joint"?"joint-rl":m==="rl_individual"?"individual-rl":m==="ai"?((g=(d=i==null?void 0:i.game)==null?void 0:d.agent)==null?void 0:g.type)==="individual"?"individual-rl":"joint-rl":String(m||"unknown")}catch{return"unknown"}}getSessionSeedInt(){try{if(typeof window<"u"&&Number.isInteger(window.__SESSION_SEED__))return window.__SESSION_SEED__}catch{}return null}seededShuffle(n,e){if(!Array.isArray(n)||n.length<=1)return n;if(!Number.isInteger(e))return this.randomShuffle(n);const t=n.slice();let a=e>>>0||1;const r=4294967296,o=1664525,s=1013904223,l=()=>(a=Math.imul(o,a)+s>>>0,a/r);for(let c=t.length-1;c>0;c--){const p=Math.floor(l()*(c+1));[t[c],t[p]]=[t[p],t[c]]}return t}randomShuffle(n){const e=n.slice();for(let t=e.length-1;t>0;t--){const a=Math.floor(Math.random()*(t+1));[e[t],e[a]]=[e[a],e[t]]}return e}getRandomDistanceConditionFor2P3G(n){var r,o,s,l,c;const e="2P3G",t=(o=(r=i.game.experiments)==null?void 0:r.numTrials)==null?void 0:o[e];if(!this.conditionSequences[e]){const d=((c=(l=(s=i==null?void 0:i.game)==null?void 0:s.players)==null?void 0:l.player2)==null?void 0:c.type)==="human"?this.getSessionSeedInt()??null:null;this.conditionSequences[e]=this.generateBalancedConditionSequence(Object.values(i.twoP3G.distanceConditions),t,d),console.log(`🎲 Generated balanced condition sequence for ${e}:`,this.conditionSequences[e])}const a=this.conditionSequences[e];return a[n%a.length]}getRandomDistanceConditionFor1P2G(n){var r,o;const e="1P2G",t=(o=(r=i.game.experiments)==null?void 0:r.numTrials)==null?void 0:o[e];this.conditionSequences[e]||(this.conditionSequences[e]=this.generateBalancedConditionSequence(Object.values(i.oneP2G.distanceConditions),t),console.log(`🎲 Generated balanced condition sequence for ${e}:`,this.conditionSequences[e]));const a=this.conditionSequences[e];return a[n%a.length]}generateBalancedConditionSequence(n,e,t=null){if(!Array.isArray(n)||n.length===0||e<=0)return[];const a=n.length,r=Math.floor(e/a);let o=e%a;const s=[];for(let d=0;d<a;d++)for(let g=0;g<r;g++)s.push(n[d]);let l=[...Array(a).keys()];l=Number.isInteger(t)?this.seededShuffle(l,t):this.randomShuffle(l);let c=0;for(;o>0;)s.push(n[l[c%a]]),c++,o--;return Number.isInteger(t)?this.seededShuffle(s,t^2654435769):this.randomShuffle(s)}syncState(n){var r,o,s,l,c;try{const p=Array.isArray((r=this.currentState)==null?void 0:r.currentGoals)?this.currentState.currentGoals:[],d=Array.isArray(n==null?void 0:n.currentGoals)?n.currentGoals:null;if(d&&Array.isArray(d)&&Array.isArray(p)&&d.length>p.length&&(((o=this.currentState)==null?void 0:o.experimentType)==="2P3G"||(n==null?void 0:n.experimentType)==="2P3G")&&this.trialData&&this.trialData.newGoalPresented===!1){const g=(h,m)=>Array.isArray(h)&&Array.isArray(m)&&h[0]===m[0]&&h[1]===m[1],f=d.find(h=>!p.some(m=>g(m,h)));if(Array.isArray(f)&&f.length===2){const h=n&&(n.distanceCondition||n.newGoalConditionType)||this.trialData.distanceCondition||this.trialData.newGoalConditionType||null;this.markNewGoalPresented([...f],h,{})}}}catch{}const e={...this.currentState,...n},t=i.multiplayer.realTimeMovement,a=Date.now();if(t&&this.currentState&&[1,2].forEach(p=>{const d=`player${p}`,g=this.currentState[d],f=n[d];if(g&&f){const h=this.lastMoveTime.get(p)||0,m=a-h,y=t.localMoveProtectionWindow;if(m<y&&(console.log(`🔧 [ROLLBACK FIX] Preserving local position for player${p} (moved ${m}ms ago)`),e[d]=g,e.gridMatrix&&Array.isArray(g)&&g.length===2)){const[T,u]=g;T>=0&&T<e.gridMatrix.length&&u>=0&&u<e.gridMatrix[0].length&&(Array.isArray(f)&&(f[0]!==g[0]||f[1]!==g[1])&&(e.gridMatrix[f[0]][f[1]]=z.blank),e.gridMatrix[T][u]=p)}}}),((s=this.currentState)==null?void 0:s.experimentType)==="2P3G"||(n==null?void 0:n.experimentType)==="2P3G"){const p=Array.isArray((l=this.currentState)==null?void 0:l.currentGoals)?this.currentState.currentGoals:[],d=Array.isArray(n==null?void 0:n.currentGoals)?n.currentGoals:[];p.length>d.length?(console.log(`🔧 [SYNC FIX] Preserving local goals (${p.length}) over remote goals (${d.length})`),e.currentGoals=p,(c=this.currentState)!=null&&c.gridMatrix&&(e.gridMatrix=this.currentState.gridMatrix)):d.length>p.length&&(console.log(`🔧 [SYNC FIX] Accepting remote goals (${d.length}) over local goals (${p.length})`),n!=null&&n.gridMatrix&&(e.gridMatrix=n.gridMatrix))}this.currentState=e}getCurrentState(){return{...this.currentState}}processPlayerMoveRealTime(n,e,t=Date.now(),a=!1,r=null){const o=i.multiplayer.realTimeMovement,s=this.lastMoveTime.get(n)||0;if(t-s<o.moveThrottleDelay)return{success:!1,reason:"throttled"};this.lastMoveTime.set(n,t),a&&this.lastLocalMoveTime.set(n,t);const l=this.isMoving;let c;try{this.isMoving=!1,c=this.processPlayerMove(n,e,r)}finally{this.isMoving=l}return c.timestamp=t,c.isLocal=a,c.moveId=`move_${this.moveCounter++}_${n}_${t}`,c}shouldSyncState(){const n=i.multiplayer.realTimeMovement;return Date.now()-this.lastSyncTime>n.stateSyncInterval}hasRecentLocalMoves(){const n=Date.now(),e=250;for(const[t,a]of this.lastLocalMoveTime.entries())if(n-a<e)return!0;return!1}markStateSynced(){this.lastSyncTime=Date.now()}clearRealTimeSync(){this.lastMoveTime.clear(),this.lastLocalMoveTime.clear(),this.moveCounter=0,this.lastSyncTime=0,this.syncPending=!1}getCurrentTrialData(){return{...this.trialData}}getTrialData(){return{...this.trialData}}getExperimentData(){return{...this.experimentData}}}class Nn{constructor(){this.canvas=null,this.ctx=null,this.cellSize=i.visual.cellSize,this.canvasSize=i.visual.canvasSize,this.padding=i.visual.padding,this.effectiveCellSize=this.cellSize+this.padding}createCanvas(){this.canvas=document.createElement("canvas"),this.canvas.width=this.canvasSize,this.canvas.height=this.canvasSize,this.canvas.style.border="2px solid #333",this.canvas.style.backgroundColor=i.visual.colors.background,this.ctx=this.canvas.getContext("2d");try{this.applyResponsiveSizing()}catch{}return this.canvas}applyResponsiveSizing(){var T,u,x;if(!this.canvas)return;const n=i.game.matrixSize,e=typeof window<"u"&&window.devicePixelRatio?window.devicePixelRatio:1,t=this.canvas.parentElement,a=(u=(T=this.canvas).closest)==null?void 0:u.call(T,'[data-grid-fit-container="true"]'),r=typeof window<"u"?window.innerWidth||0:this.canvasSize,o=typeof window<"u"?Math.floor(((x=window.visualViewport)==null?void 0:x.height)||window.innerHeight||0):this.canvasSize,s=Math.min(r,o),l=(a==null?void 0:a.clientWidth)||(t==null?void 0:t.clientWidth)||s,c=a?Number(a.getAttribute("data-grid-reserved-height")||170):0,p=c>0?Math.max(220,o-c):s*.85,d=Number(i.visual.canvasSize)||this.canvasSize,g=Math.min(l-16,r-32),f=Math.max(200,Math.floor(Math.min(p,g,d)));let h=Math.floor((f-(n+1)*this.padding)/n);h=Math.max(10,h);const m=n*h+(n+1)*this.padding;this.cellSize=h,this.effectiveCellSize=this.cellSize+this.padding,this.canvasSize=m,this.canvas.style.width=`${m}px`,this.canvas.style.height=`${m}px`;const y=Math.floor(m*e);(this.canvas.width!==y||this.canvas.height!==y)&&(this.canvas.width=y,this.canvas.height=y),this.ctx||(this.ctx=this.canvas.getContext("2d")),this.ctx&&typeof this.ctx.setTransform=="function"&&this.ctx.setTransform(e,0,0,e,0,0)}render(n,e){!n||!e||!e.gridMatrix||(this.canvas=n,this.ctx=n.getContext("2d"),this.gameState=e,this.applyResponsiveSizing(),this.ctx.fillStyle=i.visual.colors.grid,this.ctx.fillRect(0-this.padding,0-this.padding,this.canvasSize+this.padding,this.canvasSize+this.padding),this.drawGrid(),this.drawGameObjects(e.gridMatrix))}drawGrid(){const n=i.game.matrixSize;for(let e=0;e<n;e++)for(let t=0;t<n;t++)this.ctx.fillStyle=i.visual.colors.background,this.ctx.fillRect(t*this.effectiveCellSize+this.padding,e*this.effectiveCellSize+this.padding,this.cellSize,this.cellSize)}drawGameObjects(n){const e=i.game.matrixSize;for(let a=0;a<e;a++)for(let r=0;r<e;r++){const o=n[a][r];o===z.obstacle&&this.drawCell(a,r,o)}this.drawGoals();const t=this.getPlayerPositions(n);this.drawPlayersWithOverlap(t)}drawGoals(){if(this.gameState&&this.gameState.currentGoals&&Array.isArray(this.gameState.currentGoals)){for(const n of this.gameState.currentGoals)if(n&&Array.isArray(n)&&n.length>=2){const[e,t]=n;this.drawGoalWithPlayerCheck(e,t)}}else{const n=i.game.matrixSize;for(let e=0;e<n;e++)for(let t=0;t<n;t++)this.gameState.gridMatrix[e][t]===z.goal&&this.drawGoalWithPlayerCheck(e,t)}}drawGoalWithPlayerCheck(n,e){const t=this.isPlayerAtPosition(n,e),a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding;this.ctx.save(),this.ctx.fillStyle=i.visual.colors.goal,t&&(this.ctx.globalAlpha=.7),this.ctx.fillRect(a,r,this.cellSize,this.cellSize),this.ctx.restore()}isPlayerAtPosition(n,e){return this.gameState?!!(this.gameState.player1&&this.gameState.player1.length===2&&this.gameState.player1[0]===n&&this.gameState.player1[1]===e||this.gameState.player2&&this.gameState.player2.length===2&&this.gameState.player2[0]===n&&this.gameState.player2[1]===e):!1}getPlayerPositions(n){const e=i.game.matrixSize,t=[];for(let a=0;a<e;a++)for(let r=0;r<e;r++){const o=n[a][r];(o===z.player||o===z.ai_player)&&t.push({row:a,col:r,type:o})}return this.gameState&&(t.length=0,this.gameState.player1&&this.gameState.player1.length===2&&t.push({row:this.gameState.player1[0],col:this.gameState.player1[1],type:z.player}),this.gameState.player2&&this.gameState.player2.length===2&&t.push({row:this.gameState.player2[0],col:this.gameState.player2[1],type:z.ai_player})),t}drawPlayersWithOverlap(n){const e=new Map;for(const t of n){const a=`${t.row},${t.col}`;e.has(a)||e.set(a,[]),e.get(a).push(t)}for(const[t,a]of e){const[r,o]=t.split(",").map(Number);this.drawOverlappingPlayers(r,o,a)}}drawCell(n,e,t){const a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding;switch(a+this.cellSize/2,r+this.cellSize/2,this.cellSize*.35,this.ctx.save(),t){case z.player:case z.ai_player:break;case z.goal:this.ctx.fillStyle=i.visual.colors.goal,this.ctx.fillRect(a,r,this.cellSize,this.cellSize);break;case z.obstacle:this.ctx.fillStyle=i.visual.colors.obstacle,this.ctx.fillRect(a+2,r+2,this.cellSize-4,this.cellSize-4);break}this.ctx.restore()}drawOverlappingPlayers(n,e,t){const a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding,o=a+this.cellSize/2,s=r+this.cellSize/2,l=this.cellSize*.35,c=this.cellSize*.15;if(this.ctx.save(),t.length===1){const d=t[0].type===z.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=d,this.ctx.beginPath(),this.ctx.arc(o,s,l,0,2*Math.PI),this.ctx.fill()}else if(t.length>=2){const d=t[0].type===z.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=d,this.ctx.beginPath(),this.ctx.arc(o-c,s,l,0,2*Math.PI),this.ctx.fill();const f=t[1].type===z.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=f,this.ctx.beginPath(),this.ctx.arc(o+c,s,l,0,2*Math.PI),this.ctx.fill()}this.ctx.restore()}highlightCell(n,e,t="#ffff00",a=.3){if(!this.ctx)return;const r=e*this.cellSize,o=n*this.cellSize;this.ctx.save(),this.ctx.fillStyle=t,this.ctx.globalAlpha=a,this.ctx.fillRect(r,o,this.cellSize,this.cellSize),this.ctx.restore()}drawTrajectory(n,e="#ff0000",t=.5){if(!(!this.ctx||!n||n.length<2)){this.ctx.save(),this.ctx.strokeStyle=e,this.ctx.globalAlpha=t,this.ctx.lineWidth=3,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath();for(let a=0;a<n.length;a++){const[r,o]=n[a],s=o*this.cellSize+this.cellSize/2,l=r*this.cellSize+this.cellSize/2;a===0?this.ctx.moveTo(s,l):this.ctx.lineTo(s,l)}this.ctx.stroke(),this.ctx.restore()}}drawNewGoalIndicator(n,e){if(!this.ctx)return;const t=e*this.cellSize,a=n*this.cellSize,r=t+this.cellSize/2,o=a+this.cellSize/2;this.ctx.save();const s=Date.now()*.005,l=(Math.sin(s)+1)*.3+.2;this.ctx.fillStyle="#ffff00",this.ctx.globalAlpha=l,this.ctx.fillRect(t,a,this.cellSize,this.cellSize),this.ctx.globalAlpha=1,this.ctx.fillStyle="#ff0000",this.ctx.font="12px Arial",this.ctx.textAlign="center",this.ctx.fillText("NEW!",r,o-15),this.ctx.restore()}animateMove(n,e,t,a,r,o=200){return new Promise(s=>{if(!this.ctx){s();return}const l=Date.now(),c=e*this.cellSize+this.cellSize/2,p=n*this.cellSize+this.cellSize/2,d=a*this.cellSize+this.cellSize/2,g=t*this.cellSize+this.cellSize/2,f=()=>{const h=Date.now()-l,m=Math.min(h/o,1),y=1-Math.pow(1-m,3),T=c+(d-c)*y,u=p+(g-p)*y;this.ctx.save(),this.ctx.globalAlpha=.8;const x=this.cellSize*.35;r===z.player?this.ctx.fillStyle=i.visual.colors.player1:r===z.ai_player&&(this.ctx.fillStyle=i.visual.colors.player2),this.ctx.beginPath(),this.ctx.arc(T,u,x,0,2*Math.PI),this.ctx.fill(),this.ctx.restore(),m<1?requestAnimationFrame(f):s()};f()})}getCellFromPixel(n,e){const t=Math.floor(n/this.cellSize),a=Math.floor(e/this.cellSize);return a>=0&&a<i.game.matrixSize&&t>=0&&t<i.game.matrixSize?{row:a,col:t}:null}getPixelFromCell(n,e){return{x:e*this.cellSize+this.cellSize/2,y:n*this.cellSize+this.cellSize/2}}}class Fn{constructor(n){this.container=n,this.renderer=new Nn,this.eventHandlers=new Map,this.currentScreen=null,this.gameCanvas=null,this.keyboardHandler=null,this.playerIndex=0,this.gameMode="human-ai",this.lastGameState=null,this.handleResize=null}cleanupCanvas(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),this.gameCanvas=null,this.lastGameState=null}on(n,e){this.eventHandlers.has(n)||this.eventHandlers.set(n,[]),this.eventHandlers.get(n).push(e)}off(n,e){if(this.eventHandlers.has(n)){const t=this.eventHandlers.get(n),a=t.indexOf(e);a>-1&&t.splice(a,1)}}emit(n,e){this.eventHandlers.has(n)&&this.eventHandlers.get(n).forEach(t=>{try{t(e)}catch(a){console.error(`Error in UI event handler for ${n}:`,a)}})}setPlayerInfo(n,e){this.playerIndex=n,this.gameMode=e}showMainScreen(){this.cleanupCanvas(),this.currentScreen="main",this.container.innerHTML=`
    ...
    `;const t=document.getElementById("retry-connection-btn");t&&e&&t.addEventListener("click",e)}showReconnectingMessage(n){this.showGameStatus(n,"info")}showSuccessMessage(n){this.showGameStatus(n,"success"),setTimeout(()=>{this.showGameStatus("")},3e3)}destroy(){this.keyboardHandler&&document.removeEventListener("keydown",this.keyboardHandler),this.eventHandlers.clear(),this.gameCanvas=null,this.keyboardHandler=null}}const H={gridSize:15,noise:0,gamma:.9,goalReward:30,stepCost:-1,softmaxBeta:3,proximityRewardWeight:.01,coordinationRewardWeight:.02,maxPolicyIterations:15,progressivePolicyBuilding:!0,policyBuildTimeout:10,debugMode:!1,useFastOptimalPolicy:!1,enablePolicyPrecalculation:!1,jointRLImplementation:"bfs"};var Dn;try{(Dn=i==null?void 0:i.game)!=null&&Dn.matrixSize&&(H.gridSize=i.game.matrixSize)}catch{}function dn(G){return G.map(n=>`${n[0]},${n[1]}`).sort().join("|")}function Un(G,n){if(!Array.isArray(G)||G.length===0)return[];if(G.some(s=>!isFinite(s)))return new Array(G.length).fill(1/G.length);const e=Math.max(...G),r=G.map(s=>n*(s-e)).map(s=>Math.max(-700,Math.min(700,s))).map(s=>Math.exp(s)),o=r.reduce((s,l)=>s+l,0)||1;return r.map(s=>s/o)}class On{constructor(n,e){this.nx=n,this.ny=e,this.coordinates=[];for(let t=0;t<n;t++)for(let a=0;a<e;a++)this.coordinates.push([t,a]);this.terminals=[],this.obstacles=[],this.features={}}addTerminals(n){this.terminals.push(...n)}addObstacles(n){this.obstacles.push(...n)}addFeatureMap(n,e,t=0){this.features[n]={};for(const a of this.coordinates)this.features[n][a.toString()]=t;for(const a in e)this.features[n][a.toString()]=e[a]}isStateValid([n,e]){return n<0||n>=this.nx||e<0||e>=this.ny?!1:!this.obstacles.some(t=>t[0]===n&&t[1]===e)}reward(n,e,t,a=null){return a?Object.keys(a).reduce((r,o)=>r+this.features[o][t.toString()]*a[o],0):Object.keys(this.features).reduce((r,o)=>r+this.features[o][t.toString()],0)}}function Mn(G,n){return[G[0]+n[0],G[1]+n[1]]}class qn{constructor(n,e,t,a){this.noise=n,this.noiseActionSpace=e,this.terminals=t,this.isStateValid=a}call(n,e){if(this.terminals.some(s=>s[0]===n[0]&&s[1]===n[1]))return{[n.toString()]:1};const t=Mn(n,e);if(!this.isStateValid(t))return{[n.toString()]:1};const a=this.noiseActionSpace.map(s=>Mn(n,s)).filter(this.isStateValid),r=this.noise/(a.length-1||1),o={};for(const s of a)o[s.toString()]=r;return o[t.toString()]=1-this.noise,o}}class Vn{constructor(n,e=.001,t=100,a=[]){this.gamma=n,this.epsilon=e,this.maxIter=t,this.terminals=a.map(r=>r.toString())}run(n,e,t,a){const r={};for(const o of n)r[o]=this.terminals.includes(o)?0:.1;for(let o=0;o<this.maxIter;o++){const s={...r};for(const c of n)this.terminals.includes(c)||(r[c]=Math.max(...e.map(p=>Object.entries(t[c][p]).reduce((d,[g,f])=>d+f*(a[c][p][g]+this.gamma*s[g]),0))));if(n.filter(c=>!this.terminals.includes(c)).map(c=>Math.abs(r[c]-s[c])).every(c=>c<this.epsilon))break}return r}}class Wn{constructor(n,e,t,a,r,o,s){this.gridSize=n,this.actionSpace=e,this.noiseSpace=t,this.noise=a,this.gamma=r,this.goalReward=o,this.softmaxBeta=s}call(n,e){const t=new On(this.gridSize,this.gridSize);Array.isArray(n[0])||(n=[n]);const a={};for(const h of n)a[h.toString()]=this.goalReward;t.addFeatureMap("goal",a,0),t.addTerminals(n),t.addObstacles(e);const r=[];for(let h=0;h<t.nx;h++)for(let m=0;m<t.ny;m++){const y=[h,m];t.isStateValid(y)&&r.push(y.toString())}const o=new qn(this.noise,this.noiseSpace,n,t.isStateValid.bind(t)),s={};for(const h of r){s[h]={};for(const m of this.actionSpace)s[h][m.toString()]=o.call(h.split(",").map(Number),m)}const l=H.stepCost,c={};for(const h of r){c[h]={};for(const m of this.actionSpace){c[h][m.toString()]={};const y=h.split(",").map(Number);for(const T of r){const u=T.split(",").map(Number),x=n.some(P=>P.toString()===T)?l+t.reward(u,m,u):l+t.reward(y,m,y);c[h][m.toString()][T]=x}}}const d=new Vn(this.gamma,.001,100,n).run(r,this.actionSpace.map(h=>h.toString()),s,c);for(const h of n)d[h.toString()]=this.goalReward;const g={};for(const h of r){g[h]={};for(const m of this.actionSpace.map(y=>y.toString()))g[h][m]=Object.entries(s[h][m]).reduce((y,[T,u])=>y+u*(c[h][m][T]+this.gamma*d[T]),0)}const f=new Yn(g,this.softmaxBeta);return{Q_dict:g,policy:f}}}class Yn{constructor(n,e=1){this.Q=n,this.beta=e}call(n){const e=n.toString(),t=Object.keys(this.Q[e]||{}),a=t.map(o=>this.Q[e][o]),r=Un(a,this.beta);return Object.fromEntries(t.map((o,s)=>[o,r[s]]))}}function Qn(G){const n=Object.keys(G),e=Object.values(G),t=Math.max(...e),a=n.filter((o,s)=>e[s]===t);return a[Math.floor(Math.random()*a.length)].split(",").map(Number)}const kn=(()=>{const t=[[0,-1],[0,1],[-1,0],[1,0]],a=(m,y)=>m*15+y,r=m=>Math.floor(m/15),o=m=>m%15,s=(m,y)=>m>=0&&m<15&&y>=0&&y<15;function l(m,y){const T=r(m),u=o(m),[x,P]=t[y],b=T+x,w=u+P;return s(b,w)?a(b,w):m}function c(m,y,T=null){const u=r(m),x=o(m);let P=y[0],b=1/0;for(let M=0;M<y.length;M++){const S=y[M],I=Math.abs(u-S[0])+Math.abs(x-S[1]);let E;if(T!==null){const k=r(T),R=o(T),D=Math.abs(k-S[0])+Math.abs(R-S[1]);E=I+D}else E=I;E<b&&(P=S,b=E)}let w=u,v=x;return u!==P[0]?w+=P[0]<u?-1:1:x!==P[1]&&(v+=P[1]<x?-1:1),a(w,v)}const p=new Map;function d(m,y=1){const T=new Set(m.map(([k,R])=>a(k,R))),u=225*225,x=new Float32Array(u),P=new Float32Array(u*4),b=H.goalReward,w=H.stepCost,v=H.gamma;x.fill(-1e3);for(let k=0;k<u;k++){const R=Math.floor(k/225),D=k%225,L=T.has(R),O=T.has(D);if(L&&O&&R===D){x[k]=0;for(let N=0;N<4;N++)P[k*4+N]=0}}let M,S=0;const I=1e3,E=1e-6;do{M=0,S++;for(let k=0;k<u;k++){const R=Math.floor(k/225),D=k%225,L=T.has(R),O=T.has(D);if(L&&O&&R===D){x[k]=0;for(let F=0;F<4;F++)P[k*4+F]=0;continue}let N=-1/0;for(let F=0;F<4;F++){const q=L?R:l(R,F),B=c(D,m,q),C=T.has(q),Q=T.has(B),Z=C&&Q&&q===B;let nn=w;Z?nn=b:C&&Q&&q!==B?nn=w*.5:(C||Q)&&(nn=w*.8);const gn=q*225+B,an=nn+(Z?0:v*x[gn]);P[k*4+F]=an,an>N&&(N=an)}const _=Math.abs(N-x[k]);_>M&&(M=_),x[k]=N}if(S>I){console.warn(`Joint RL VI did not converge after ${I} iters Δ=${M}`);break}}while(M>E);return{Q:P,goalSet:T,beta:y}}function g(m,y,T,u=null){u==null&&(u=H.softmaxBeta);const x=dn(T)+"|"+u;p.has(x)||p.set(x,d(T,u));const{Q:P,goalSet:b}=p.get(x),w=(C,Q)=>C*15+Q,v=w(m[0],m[1]),M=w(y[0],y[1]),S=b.has(v),I=b.has(M);if(S&&I&&v===M)return null;const R=(v*225+M)*4,D=[P[R],P[R+1],P[R+2],P[R+3]];if(D.some(C=>!isFinite(C)))return t[Math.floor(Math.random()*t.length)];if(u>10){const C=Math.max(...D),Q=D.map((Z,nn)=>({q:Z,i:nn})).filter(Z=>Z.q===C);return t[Q[Math.floor(Math.random()*Q.length)].i]}const L=Math.max(...D),N=D.map(C=>u*(C-L)).map(C=>Math.max(-700,Math.min(700,C))).map(C=>Math.exp(C)),_=N.reduce((C,Q)=>C+Q,0);if(!isFinite(_)||_===0){const C=D.indexOf(L);return t[C]}const F=Math.random()*_;let q=0;for(let C=0;C<N.length;C++)if(q+=N[C],F<q)return t[C];const B=D.indexOf(L);return t[B]}function f(m){const y=H.softmaxBeta,T=dn(m)+"|"+y;p.has(T)||p.set(T,d(m,y))}function h(){p.clear()}return{getAction:g,precalc:f,clear:h}})(),An=(()=>{const G=H.gridSize||15,n=H.gridSize||15,e=G*n,t=[[0,-1],[0,1],[-1,0],[1,0]],a=(h,m)=>h*n+m,r=h=>Math.floor(h/n),o=h=>h%n,s=(h,m)=>h>=0&&h<G&&m>=0&&m<n,l=(h,m)=>{const y=r(h),T=o(h),u=y+t[m][0],x=T+t[m][1];return s(u,x)?a(u,x):h},c=new Map;function p(h,m=1){const y=new Set(h.map(([S,I])=>a(S,I))),T=e*e,u=new Float32Array(T*16),x=H.goalReward,P=H.stepCost,b=H.gamma,w=new Array(e);for(let S=0;S<e;S++){w[S]=new Array(h.length);const I=Math.floor(S/n),E=S%n;for(let k=0;k<h.length;k++){const[R,D]=h[k];w[S][k]=Math.abs(I-R)+Math.abs(E-D)}}const v=new Map;function M(S,I,E){if(E)return 0;const k=S<=I?`${S}-${I}`:`${I}-${S}`;if(v.has(k))return v.get(k);let R=1/0;for(let L=0;L<h.length;L++){const O=w[S][L]+w[I][L];O<R&&(R=O)}const D=-H.proximityRewardWeight*R;return v.set(k,D),D}for(let S=0;S<T;S++){const I=Math.floor(S/e),E=S%e;if(y.has(I)&&y.has(E)&&I===E){for(let k=0;k<16;k++)u[S*16+k]=0;continue}for(let k=0;k<4;k++){const R=y.has(I)?I:l(I,k);for(let D=0;D<4;D++){const L=y.has(E)?E:l(E,D),O=k*4+D,X=y.has(R)&&y.has(L)&&R===L,N=M(R,L,X),_=X?x:P+N;let F=0;if(!X){let q=1/0;for(let B=0;B<h.length;B++){const C=w[R][B]+w[L][B];C<q&&(q=C)}F=b*(x+P*q)}u[S*16+O]=_+F}}}return{Q:u,goalSet:y,beta:m}}function d(h,m,y,T=null){T==null&&(T=H.softmaxBeta);const u=dn(y)+"|"+T;c.has(u)||c.set(u,p(y,T));const{Q:x,goalSet:P}=c.get(u),b=a(h[0],h[1]),w=a(m[0],m[1]);if(P.has(b)&&P.has(w)&&b===w)return null;const M=(b*e+w)*16,S=[x[M],x[M+1],x[M+2],x[M+3],x[M+4],x[M+5],x[M+6],x[M+7],x[M+8],x[M+9],x[M+10],x[M+11],x[M+12],x[M+13],x[M+14],x[M+15]],I=P.has(w),E=P.has(b);if(I&&!E)for(let _=0;_<16;_++)Math.floor(_/4)<4&&(S[_]*=.5);if(S.some(_=>!isFinite(_)))return t[Math.floor(Math.random()*t.length)];const k=Math.max(...S),L=S.map(_=>T*(_-k)).map(_=>Math.max(-700,Math.min(700,_))).map(_=>Math.exp(_)),O=L.reduce((_,F)=>_+F,0);if(!isFinite(O)||O===0)return t[Math.floor(Math.random()*t.length)];const X=Math.random()*O;let N=0;for(let _=0;_<16;_++)if(N+=L[_],X<N){const F=Math.floor(_/4);return t[F]}return t[0]}function g(h){const m=H.softmaxBeta,y=dn(h)+"|"+m;c.has(y)||c.set(y,p(h,m))}function f(){c.clear()}return{getAction:d,precalc:g,clear:f}})();class In{constructor(){this.isPreCalculating=!1}getAIAction(n,e,t,a=null){if(!t||t.length===0)return[0,0];try{if(a&&i.game.agent.type==="joint"){const o=(H.jointRLImplementation||"vi4").toLowerCase()==="bfs"?An.getAction(e,a,t,H.softmaxBeta):kn.getAction(e,a,t,H.softmaxBeta);return o===null?[0,0]:o}return this.getIndividualRLAction(e,t)}catch(r){return console.error("Error in RL agent:",r),[0,0]}}getIndividualRLAction(n,e){const t=[[0,-1],[0,1],[-1,0],[1,0]],a=[...t],r=[],o=new Wn(H.gridSize,t,a,H.noise,H.gamma,H.goalReward,H.softmaxBeta),{policy:s}=o.call(e,r),l=s.call(n);return Qn(l)}precalculatePolicyForGoals(n,e){this.isPreCalculating||(this.isPreCalculating=!0,setTimeout(()=>{try{(H.jointRLImplementation||"vi4").toLowerCase()==="bfs"?An.precalc(n):kn.precalc(n)}finally{this.isPreCalculating=!1}},0))}enableAutoPolicyPrecalculation(){}resetNewGoalPreCalculationFlag(){}}class pn{constructor(){this.baseUrl=i.server.url||""}static guidanceFor(n){switch(n){case"2P2G":return"You will collaborate  with another player. Each round, you can win if both of you go to the same restaurant. You lose the round if you end up at different restaurants. For each round that you win, you earn an additional 10 points.";case"2P3G":return"You will collaborate  with another player. Each round, you can win if both of you go to the same restaurant. You lose the round if you end up at different restaurants. Note that some restaurants are already open when the round starts. Others may appear later. For each round that you win, you earn an additional 10 points.";case"1P2G":return"Single player: reach any open goal.";case"1P1G":return"Single player: reach the goal.";default:return"Choose the best single step to reach a valid goal."}}static buildRelativeInfo(n,e="player2"){const t=n[e],a=n.currentGoals||[];if(!t||a.length===0)return null;let r=null,o=1/0;for(const l of a){const c=Math.abs(l[0]-t[0])+Math.abs(l[1]-t[1]);c<o&&(o=c,r=l)}const s=r?{dRow:r[0]-t[0],dCol:r[1]-t[1]}:null;return{nearestGoal:r,manhattanDistance:o,deltaToNearest:s}}async getNextAction(n,e={}){var T,u,x,P,b,w,v,M;const t=n.experimentType,a=e.guidance||pn.guidanceFor(t),o=(Number(e.aiPlayerNumber)===1?1:2)===1?"player1":"player2",s=((u=(T=i==null?void 0:i.game)==null?void 0:T.agent)==null?void 0:u.gpt)||{},l=n.trialData||null,c=Math.max(0,Number((x=s==null?void 0:s.memory)==null?void 0:x.maxSteps)||0),p=Array.isArray(l==null?void 0:l.player1Trajectory)?l.player1Trajectory:[],d=Array.isArray(l==null?void 0:l.player2Trajectory)?l.player2Trajectory:[],g=S=>c>0?S.slice(-c):S,f={guidance:a,matrix:n.gridMatrix,currentPlayer:{label:o,pos:n[o]},goals:n.currentGoals,relativeInfo:pn.buildRelativeInfo(n,o),model:e.model||s.model||void 0,temperature:typeof e.temperature=="number"?e.temperature:typeof s.temperature=="number"?s.temperature:void 0,memory:{enabled:!!((P=s==null?void 0:s.memory)!=null&&P.enabled),maxSteps:c,trajectories:(b=s==null?void 0:s.memory)!=null&&b.enabled?{player1:g(p),player2:g(d)}:void 0}},h=`${this.baseUrl.replace(/\/$/,"")}/api/ai/gpt/action`,m=await fetch(h,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(f)});if(!m.ok){const S=await m.text();throw new Error(`GPT action request failed: ${m.status} ${S}`)}const y=await m.json();try{const S=y&&(y.model||y.modelUsed);if(S){const I=(M=(v=(w=i==null?void 0:i.game)==null?void 0:w.agent)==null?void 0:v.gpt)==null?void 0:M.model;(!I||String(I).trim()!==String(S).trim())&&(i.game.agent.gpt.model=String(S).trim())}}catch{}return y&&Object.prototype.hasOwnProperty.call(y,"inferredGoal")?{action:(y==null?void 0:y.action)||null,inferredGoal:(y==null?void 0:y.inferredGoal)??null,model:y==null?void 0:y.model}:(y==null?void 0:y.action)||null}}class cn{static generateRandomizedDistanceSequence(n){const e=[this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER2,this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER1,this.DISTANCE_CONDITIONS.EQUAL_TO_BOTH,this.DISTANCE_CONDITIONS.NO_NEW_GOAL],t=e.length,a=Math.floor(n/t),r=n%t,o=[];for(let s=0;s<t;s++)for(let l=0;l<a;l++)o.push(e[s]);for(let s=0;s<r;s++){const l=e[Math.floor(Math.random()*t)];o.push(l)}for(let s=o.length-1;s>0;s--){const l=Math.floor(Math.random()*(s+1));[o[s],o[l]]=[o[l],o[s]]}return o}static generateNewGoal1P2G(n,e,t,a){var u,x,P,b,w,v,M;if(!n||!e)return null;const r=i.oneP2G;if(!r||a===((u=r==null?void 0:r.distanceConditions)==null?void 0:u.NO_NEW_GOAL))return null;const o=A.calculateGridDistance(n,e),s=i.game.matrixSize,l=(x=r.goalConstraints)==null?void 0:x.minDistanceFromHuman,c=(P=r.goalConstraints)==null?void 0:P.maxDistanceFromHuman,p=(b=r.goalConstraints)==null?void 0:b.minDistanceBetweenGoals,d=(w=r.distanceConstraint)==null?void 0:w.closerThreshold,g=(v=r.distanceConstraint)==null?void 0:v.fartherThreshold,f=!!((M=r.distanceConstraint)!=null&&M.allowEqualDistance),h=(S,I)=>{if(Array.isArray(t)){for(const E of t)if(E[0]===S&&E[1]===I)return!0}return n[0]===S&&n[1]===I},m=S=>{var I,E,k;switch(a){case((I=r.distanceConditions)==null?void 0:I.CLOSER_TO_PLAYER1):return S<=o-d;case((E=r.distanceConditions)==null?void 0:E.FARTHER_TO_PLAYER1):return S>=o+g;case((k=r.distanceConditions)==null?void 0:k.EQUAL_TO_PLAYER1):return f;default:return!1}},y=[];for(let S=0;S<s;S++)for(let I=0;I<s;I++){if(h(S,I))continue;const E=[S,I],k=A.calculateGridDistance(n,E);k<l||k>c||A.calculateGridDistance(e,E)<p||m(k)&&y.push(E)}if(y.length===0)for(let S=0;S<s;S++)for(let I=0;I<s;I++){if(h(S,I))continue;const E=[S,I],k=A.calculateGridDistance(n,E);k>=1&&k<=Math.max(10,c)&&y.push(E)}if(y.length===0)return null;const T=y[Math.floor(Math.random()*y.length)];return{position:T,conditionType:a,distanceToPlayer1:A.calculateGridDistance(n,T)}}static checkNewGoalPresentation1P2G(n,e,t){if(!n||!e||!n.currentGoals||n.currentGoals.length!==2||e.newGoalPresented)return null;const a=e.player1CurrentGoal;if((Array.isArray(a)&&a.length>0?a[a.length-1]:null)===null)return null;const o=n.currentGoals[0],s=this.generateNewGoal1P2G(n.player1,o,n.currentGoals,t);return s?{position:s.position,conditionType:s.conditionType,distanceToPlayer1:s.distanceToPlayer1}:null}static generateNewGoal(n,e,t,a,r){if(r===this.DISTANCE_CONDITIONS.NO_NEW_GOAL||a===null||a>=t.length)return null;const o=t[a],s=A.calculateGridDistance(e,o),l=A.calculateGridDistance(n,o),c=s+l,p=[],d=i.game.matrixSize,g=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},f=Number.isFinite(g.minDistanceFromHuman)?g.minDistanceFromHuman:1,h=Number.isFinite(g.maxDistanceFromHuman)?g.maxDistanceFromHuman:1/0;for(let y=0;y<d;y++)for(let T=0;T<d;T++){const u=[y,T];if(this.isPositionOccupied(u,t,e,n))continue;const x=A.calculateGridDistance(e,u),P=A.calculateGridDistance(n,u),b=x+P;x<f||x>h||P<f||P>h||this.meetsDistanceCondition(r,x,P,s,l,b,c)&&p.push({position:u,conditionType:r,distanceToPlayer1:x,distanceToPlayer2:P,distanceSum:b})}if(p.length>0)return p[Math.floor(Math.random()*p.length)];const m=this.findRelaxedValidPositions(e,n,t,r);return m.length>0?m[Math.floor(Math.random()*m.length)]:null}static isPositionOccupied(n,e,t,a){const[r,o]=n;for(const s of e)if(s[0]===r&&s[1]===o)return!0;return t[0]===r&&t[1]===o||a[0]===r&&a[1]===o}static meetsDistanceCondition(n,e,t,a,r,o,s){const l=i&&i.twoP3G&&i.twoP3G.distanceConstraint||{},c=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},p=Number.isFinite(l.closerThreshold)?l.closerThreshold:1,d=!!l.allowEqualDistance,g=Number.isFinite(l.maxDistanceIncrease)?l.maxDistanceIncrease:0,h=!!c.maintainDistanceSum?o===s:o<=s+g;switch(n){case this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER2:return(d?t<=r-p:t<r-p)&&h;case this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER1:return(d?e<=a-p:e<a-p)&&h;case this.DISTANCE_CONDITIONS.EQUAL_TO_BOTH:{const m=Math.abs(e-a),y=Math.abs(t-r),T=Math.abs(t-e),u=d?1:0,x=d?1:0;return m<=u&&y<=u&&T<=u&&Math.abs(o-s)<=x}default:return!1}}static findRelaxedValidPositions(n,e,t,a){const r=[],o=i.game.matrixSize,s=i&&i.twoP3G&&i.twoP3G.distanceConstraint||{},l=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},c=Number.isFinite(l.minDistanceFromHuman)?l.minDistanceFromHuman:2,p=Number.isFinite(l.maxDistanceFromHuman)?l.maxDistanceFromHuman:Number.isFinite(s.maxDistanceIncrease)?Math.max(10,2+s.maxDistanceIncrease):10;for(let d=0;d<o;d++)for(let g=0;g<o;g++){const f=[d,g];if(!this.isPositionOccupied(f,t,n,e)){const h=A.calculateGridDistance(n,f),m=A.calculateGridDistance(e,f);h>=c&&h<=p&&m>=c&&m<=p&&r.push({position:f,conditionType:a,distanceToPlayer1:h,distanceToPlayer2:m,distanceSum:h+m})}}return r}static checkNewGoalPresentation2P3G(n,e,t){const{player1:a,player2:r,currentGoals:o}=n;if(!a||!r||!o||o.length<2||e.newGoalPresented)return null;const s=this.getPlayerCurrentGoal(e.player1CurrentGoal),l=this.getPlayerCurrentGoal(e.player2CurrentGoal);if(s!==null&&l!==null&&s===l){console.log("=== SHARED GOAL DETECTED ==="),console.log("Player1 goal:",s,"Player2 goal:",l);const c=this.generateNewGoal(r,a,o,s,t);if(c)return console.log("=== NEW GOAL GENERATED ==="),console.log("New goal position:",c.position),console.log("Distance condition:",t),{position:c.position,conditionType:c.conditionType,distanceToPlayer1:c.distanceToPlayer1,distanceToPlayer2:c.distanceToPlayer2}}return null}static getPlayerCurrentGoal(n){return!n||n.length===0?null:n[n.length-1]}}xn(cn,"DISTANCE_CONDITIONS",{CLOSER_TO_PLAYER2:"closer_to_player2",CLOSER_TO_PLAYER1:"closer_to_player1",EQUAL_TO_BOTH:"equal_to_both",NO_NEW_GOAL:"no_new_goal"});const Kn=`var MapsFor1P1G = {
    "0": [
        {
            "initPlayerGrid": [
                7,
    ...
    `,!(((u=(T=(y=i==null?void 0:i.game)==null?void 0:y.players)==null?void 0:T.player2)==null?void 0:u.type)==="human")){this.gameMode="human-ai",setTimeout(()=>{this.nextStage()},Math.max(0,r-Date.now()));return}const c=x=>{var P;if(x.code==="Space"||x.key===" "){if(x.preventDefault(),Date.now()<r)return;const b=Date.now(),w=b-s;console.log("⏱️ [WAITING] Skipped after waiting duration:",w+"ms ("+(w/1e3).toFixed(1)+"s)"),this.recordWaitingTime(s,b,w,"skip",n,e),document.removeEventListener("keydown",c),console.log("⏭️ Skipping multiplayer waiting after min wait - continuing with AI partner");const v=((P=i==null?void 0:i.multiplayer)==null?void 0:P.fallbackAIType)||"rl_joint";U.setPlayerType(2,v);try{this.emit("fallback-to-ai",{reason:"waiting-skip",stage:"waiting-for-partner",at:Date.now(),fallbackAIType:v})}catch{}this.nextStage()}};document.addEventListener("keydown",c),this.emit("waiting-for-partner",{experimentType:n,experimentIndex:e});const p=document.getElementById("cancel-wait-btn");p&&(p.onclick=()=>{console.log("⚠️ Waiting canceled by user"),window.close()});const d=x=>{console.log("👥 Partner connected - will advance after minimum waiting time",x),this.gameMode="human-human",o=!0;const P=Date.now(),b=P-s;console.log("⏱️ [WAITING] Partner found! Waiting duration:",b+"ms ("+(b/1e3).toFixed(1)+"s)"),this.recordWaitingTime(s,P,b,"partner_found",n,e),document.removeEventListener("keydown",c),this.off("partner-connected",d);let w=r;if(x&&x.connectedAt){const M=x.connectedAt+t;w=Math.max(w,M)}const v=Math.max(0,w-Date.now());setTimeout(()=>this.nextStage(),v)};this.eventHandlers.delete("partner-connected"),this.on("partner-connected",d),setTimeout(()=>{var x,P;if(!o){const b=Date.now(),w=b-s;console.log("⏱️ [WAITING] Timeout after waiting duration:",w+"ms ("+(w/1e3).toFixed(1)+"s)"),this.recordWaitingTime(s,b,w,"timeout",n,e),console.log(`⌛ No partner found after ${a}ms - falling back to AI mode`);const v=((x=i==null?void 0:i.multiplayer)==null?void 0:x.fallbackAIType)||"rl_joint";U.setPlayerType(2,v),this.gameMode="human-ai",document.removeEventListener("keydown",c);try{this.emit("fallback-to-ai",{reason:"waiting-timeout",stage:"waiting-for-partner",at:Date.now(),fallbackAIType:v})}catch{}try{(P=i==null?void 0:i.debug)!=null&&P.disableConsoleLogs||console.log("[DEBUG] Timeline emitting ai-fallback-activated event (waiting timeout)")}catch{}this.emit("ai-fallback-activated",{fallbackType:v,aiPlayerNumber:2}),this.nextStage()}},a)}showReadyToPlayStage(n,e){if(this.isHumanHumanMode()&&i.game.players.player2.type==="human"){this.container.innerHTML=`
        <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
    ...
    `;const o=s=>{var l;if(s.code==="Space"||s.key===" ")if(s.preventDefault(),s.stopPropagation(),document.removeEventListener("keydown",o,!0),this.emit("match-play-ready"),this.isHumanHumanMode()&&i.game.players.player2.type==="human"){const c=document.getElementById("match-status");c&&(c.style.display="block");const p=(l=i==null?void 0:i.multiplayer)==null?void 0:l.matchPlayReadyTimeout;let d=null;const g=()=>{var h,m,y,T;try{console.log(`⌛ Match-play wait exceeded (${p}ms) - falling back to AI mode`);const u=((h=i==null?void 0:i.multiplayer)==null?void 0:h.fallbackAIType)||"rl_joint";try{(m=i==null?void 0:i.debug)!=null&&m.disableConsoleLogs||console.log(`[DEBUG] Timeline fallback - fallbackType: ${u}`)}catch{}U.setPlayerType(2,u);try{(y=i==null?void 0:i.debug)!=null&&y.disableConsoleLogs||console.log(`[DEBUG] Timeline fallback - After setPlayerType, Player2: ${i.game.players.player2.type}`)}catch{}this.gameMode="human-ai",this.off("all-players-ready",f);try{(T=i==null?void 0:i.debug)!=null&&T.disableConsoleLogs||console.log("[DEBUG] Timeline emitting ai-fallback-activated event")}catch{}this.emit("ai-fallback-activated",{fallbackType:u,aiPlayerNumber:2})}catch{}this.nextStage()},f=()=>{this.off("all-players-ready",f),d&&(clearTimeout(d),d=null),this.nextStage()};this.eventHandlers.delete("all-players-ready"),this.on("all-players-ready",f),d=setTimeout(()=>{var m;const h=((m=i==null?void 0:i.multiplayer)==null?void 0:m.fallbackAIType)||"rl_joint";try{this.emit("fallback-to-ai",{reason:"match-play-timeout",stage:"match-play",at:Date.now(),fallbackAIType:h})}catch{}g()},p)}else this.nextStage()};document.addEventListener("keydown",o,!0),document.body.focus()}showFixationStage(n,e,t){this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
        <div style="text-align: center;">
    ...
    `,this.emit("start-trial",{experimentType:n,experimentIndex:e,trialIndex:t,onComplete:p=>{this.experimentData.experiments[n]||(this.experimentData.experiments[n]=[]),this.experimentData.experiments[n].push(p),n.includes("2P")&&i.game.successThreshold.enabled&&this.updateSuccessThresholdTracking(p.success,t),console.log(`✅ Trial ${t} completed`),this.nextStage()}})}showPostTrialStage(n,e,t){var l,c,p,d;const a=(l=this.experimentData.experiments[n])==null?void 0:l[t],r=(a==null?void 0:a.success)||!1,o=((d=(p=(c=i==null?void 0:i.game)==null?void 0:c.experiments)==null?void 0:p.numTrials)==null?void 0:d[n])||1,s=document.getElementById("game-canvas-container");s?this.emit("show-trial-feedback",{success:r,experimentType:n,trialIndex:t,canvasContainer:s}):(this.container.innerHTML=`
        <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
    ...
    `,this.stages.some(d=>d.type==="questionnaire")||this.stages.push({type:"questionnaire",handler:()=>this.showQuestionnaireStage()});const p=document.getElementById("continueToQuestionnaireBtn");p&&p.addEventListener("click",()=>{console.log("🎮 Game Feedback Stage: Continue button clicked"),this.nextStage()})}showQuestionnaireStage(){const n=()=>{const a=[{name:"ai_detection",title:"Page 1 of 3",prompt:"Do you think the other player is a person or a computer?",options:["Person","Computer"],optionImages:["person.png","computer.png"]},{name:"collaboration_rating",title:"Page 2 of 3",prompt:"How well did the other player collaborate with you?",options:["Good collaborator","Bad collaborator"],optionImages:["good.png","bad.png"]},{name:"play_again",title:"Page 3 of 3",prompt:"Would you like to play this game again in the future?",options:["Yes","No"],optionImages:["yes.png","no.png"]}],r={};let o=0,s=0,l=null;const c=window.speechSynthesis||null,p=async(h=!0)=>{const m=o+1,y=this.assetUrl(`question${m}.mp3`);return h&&(c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null)),new Promise(T=>{const u=new Audio(y);u.onloadeddata=()=>{l=u,u.play().then(()=>{u.onended=()=>{l=null,T()},u.onerror=()=>{l=null,console.warn("Questionnaire prompt audio playback failed:",y),T()}}).catch(()=>T())},u.onerror=()=>{console.warn("Questionnaire prompt audio missing or failed to load:",y),T()},u.load()})},d=(h=!1)=>{const m=a[o],y=m.optionImages||[],T=m.options.map((x,P)=>{const b=P===s,w=b?"#4f46e5":"#e5e7eb",v=b?"#eef2ff":"#ffffff",M=y[P]?this.assetUrl(y[P]):"";return`
            ...
            ">
              ${M?`<img src="${M}" alt="" style="max-width: min(200px, 38vw); max-height: 180px; height: auto; display: block; object-fit: contain;" />`:`<span style="font-size: 18px; color: #333;">${x}</span>`}
          ...
          </div>`,h&&p(!0),this.container.querySelectorAll(".image-option").forEach(x=>{x.addEventListener("click",()=>{s=Number(x.getAttribute("data-idx")||"0"),r[m.name]=m.options[s],c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),o<a.length-1?(o+=1,s=0,d(!0)):(document.removeEventListener("keydown",g),this.experimentData.questionnaire=r,console.log("📝 Questionnaire completed"),this.nextStage())})})},g=h=>{const m=h.code==="ArrowUp"||h.key==="ArrowUp"||h.code==="ArrowLeft"||h.key==="ArrowLeft",y=h.code==="ArrowDown"||h.key==="ArrowDown"||h.code==="ArrowRight"||h.key==="ArrowRight";m?(h.preventDefault(),s=Math.max(0,s-1),d(!1)):y?(h.preventDefault(),s=Math.min(a[o].options.length-1,s+1),d(!1)):(h.code==="Space"||h.key===" ")&&(h.preventDefault(),c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),r[a[o].name]=a[o].options[s],o<a.length-1?(o+=1,s=0,d(!0)):(document.removeEventListener("keydown",g),c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),this.experimentData.questionnaire=r,console.log("📝 Questionnaire completed"),this.nextStage()))};d(!0),document.addEventListener("keydown",g);const f=()=>{c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),document.removeEventListener("keydown",g)};this._questionnaireCleanup=f};this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
    ...
    `,o=({title:c,titleColor:p="#333",subtitle:d,intro:g="",items:f,videoId:h,videoSrc:m})=>({html:`
