var En=Object.defineProperty;var Cn=(P,n,e)=>n in P?En(P,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):P[n]=e;var fn=(P,n,e)=>(Cn(P,typeof n!="symbol"?n+"":n,e),e);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function e(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function t(a){if(a.ep)return;a.ep=!0;const r=e(a);fetch(a.href,r)}})();const X=(P,n)=>{try{return{BASE_URL:"/MinimalCoordinationGame-CHS-unmoderated/",MODE:"production",DEV:!1,PROD:!0,SSR:!1}[P]||n}catch{return console.warn(`Environment variable ${P} not available, using default: ${n}`),n}},Gn=typeof window<"u"&&window.location&&window.location.origin?window.location.origin:"http://localhost:3001",Pn="gridworld.rlStudyCondition",xn=()=>Math.random()<.5?"joint":"individual",_n=()=>{const P=String(X("VITE_STUDY_RL_CONDITION","")||"").toLowerCase();if(P==="joint"||P==="individual")return P;try{if(typeof sessionStorage<"u"){const n=sessionStorage.getItem(Pn);if(n==="joint"||n==="individual")return n;const e=xn();return sessionStorage.setItem(Pn,e),e}}catch{}return xn()},pn=_n(),Tn=pn==="joint"?"rl_joint":"rl_individual",Rn=pn==="joint"?"joint":"individual",i={debug:{disableConsoleLogs:X("VITE_DISABLE_DEBUG_LOGS","false")==="true"},server:{url:X("VITE_SERVER_URL",Gn),reconnectAttempts:3,reconnectDelay:1e3,googleAppsScriptUrl:X("VITE_GOOGLE_APPS_SCRIPT_URL","https://script.google.com/macros/s/AKfycbyfQ-XKsoFbmQZGM7c741rEXh2ZUpVK-uUIu9ycooXKnaxM5-hRSzIUhQ-uWZ668Qql/exec"),enableGoogleDriveSave:X("VITE_ENABLE_GOOGLE_DRIVE_SAVE","true")==="true"},game:{name:"GridWorldExperiment",version:"2.0.0",prolificCompletionCode:X("VITE_PROLIFIC_COMPLETION_CODE","CTNDR8GV"),matrixSize:15,maxGameLength:60,studyRLCondition:pn,players:{player1:{type:"human",color:"red",description:"Human player (you)"},player2:{type:Tn,color:"purple",description:"Human, GPT, or RL partner"}},experiments:{order:["1P1G","1P2G","2P2G","2P3G"],numTrials:{"1P1G":1,"1P2G":1,"2P2G":1,"2P3G":1}},successThreshold:{enabled:!1,consecutiveSuccessesRequired:5,minTrialsBeforeCheck:12,maxTrials:24,randomSamplingAfterTrial:12},timing:{trialToFeedbackDelay:500,feedbackDisplayDuration:1e3,preTrialDisplayDuration:2e3,fixationDuration:1e3,newGoalMessageDuration:0,maxTrialDurationMs:60*1e3,waitingForPartnerMinDuration:3*1e3,waitingForPartnerMaxDuration:3*1e3},agent:{type:Rn,delay:500,independentDelay:300,synchronizedMoves:!0,gpt:{model:"gpt",temperature:0,memory:{enabled:!0,maxSteps:50}}}},visual:{canvasSize:632,cellSize:40,padding:2,colors:{background:"#ffffff",grid:"#cccccc",player1:"#ff0000",player2:"#8000ff",goal:"#0066ff",obstacle:"#333333"}},tts:{useOpenAI:X("VITE_USE_OPENAI_TTS","true")==="true",openAIVoice:X("VITE_OPENAI_TTS_VOICE","nova"),ttsServerUrl:X("VITE_TTS_SERVER_URL",Gn),useCustomAudio:X("VITE_USE_CUSTOM_AUDIO","true")==="true",customAudioPath:X("VITE_CUSTOM_AUDIO_PATH","/audio/questionnaire/")},oneP2G:{minStepsBeforeNewGoal:1,distanceConditions:{CLOSER_TO_PLAYER1:"closer_to_player1",FARTHER_TO_PLAYER1:"farther_to_player1",EQUAL_TO_PLAYER1:"equal_to_player1",NO_NEW_GOAL:"no_new_goal"},distanceConstraint:{closerThreshold:2,fartherThreshold:2,equalTolerance:!1,allowEqualDistance:!1},goalConstraints:{minDistanceFromHuman:1,maxDistanceFromHuman:12,minDistanceBetweenGoals:3,avoidRectangleArea:!1,blockPathCheck:!1}},twoP3G:{minStepsBeforeNewGoal:1,newGoalMessageDuration:5e3,distanceConditions:{CLOSER_TO_PLAYER2:"closer_to_player2",CLOSER_TO_PLAYER1:"closer_to_player1",EQUAL_TO_BOTH:"equal_to_both",NO_NEW_GOAL:"no_new_goal"},distanceConstraint:{closerThreshold:2,allowEqualDistance:!1,maxDistanceIncrease:5},goalConstraints:{minDistanceFromHuman:1,maxDistanceFromHuman:12,avoidRectangleArea:!1,maintainDistanceSum:!1,blockPathCheck:!1}},multiplayer:{maxWaitTime:6e4,roomTimeout:3e5,reconnectAttempts:3,syncInterval:100,moveTimeout:1e4,synchronizedHumanTurns:!1,matchPlayReadyTimeout:1e4,fallbackAIType:Tn,inactivityFallback:{enabled:!0,timeoutMs:4e4,checkIntervalMs:5e3},realTimeMovement:{moveThrottleDelay:100,immediateLocalUpdates:!0,stateSyncInterval:300,moveValidationTimeout:1e3,localMoveProtectionWindow:300}}},$={blank:0,player:1,ai_player:2,goal:3,obstacle:4},rn={arrowup:{movement:[-1,0],name:"up"},arrowdown:{movement:[1,0],name:"down"},arrowleft:{movement:[0,-1],name:"left"},arrowright:{movement:[0,1],name:"right"}};(()=>{var P;try{if((P=i==null?void 0:i.debug)==null?void 0:P.disableConsoleLogs){const e=()=>{};typeof console<"u"&&(console.log=e,console.info=e,console.debug=e)}}catch{}})();const q={setPlayerType(P,n){const e=n==="ai"?"rl_joint":n;["human","gpt","rl_individual","rl_joint"].includes(e)&&(i.game.players[`player${P}`].type=e,P===2&&(e==="rl_joint"&&(i.game.agent.type="joint",i.game.studyRLCondition="joint"),e==="rl_individual"&&(i.game.agent.type="individual",i.game.studyRLCondition="individual")))},getPlayerType(P){return i.game.players[`player${P}`].type},isHumanAIMode(){return i.game.players.player2.type!=="human"},isHumanHumanMode(){return i.game.players.player2.type==="human"},setExperimentOrder(P){i.game.experiments.order=P},getNumTrials(P){return i.game.experiments.numTrials[P]||12},isSynchronizedHumanTurnsEnabled(P){var n;try{return String(P||"").toUpperCase().includes("2P")&&!!((n=i==null?void 0:i.multiplayer)!=null&&n.synchronizedHumanTurns)}catch{return!1}}},bn=window.io;class Ln{constructor(){this.socket=null,this.isConnected=!1,this.eventHandlers=new Map,this.reconnectAttempts=0,this.maxReconnectAttempts=i.server.reconnectAttempts}async connect(){return new Promise((n,e)=>{if(!bn){e(new Error("Socket.IO not available. Please ensure the Socket.IO client is loaded."));return}this.socket=bn(i.server.url,{transports:["websocket"],upgrade:!1}),this.socket.on("connect",()=>{console.log("Connected to server"),this.isConnected=!0,this.reconnectAttempts=0,n()}),this.socket.on("disconnect",t=>{console.log("Disconnected from server:",t),this.isConnected=!1,this.emit("disconnect",t),t!=="io server disconnect"&&this.handleReconnection()}),this.socket.on("connect_error",t=>{console.error("Connection error:",t),this.isConnected=!1,this.reconnectAttempts===0&&e(t)}),this.setupEventForwarding(),setTimeout(()=>{this.isConnected||e(new Error("Connection timeout"))},1e4)})}setupEventForwarding(){["room-joined","player-joined","room-full","player-disconnected","player-ready-status","match-play-ready-status","game-started","player-action","game-state-update","trial-completed","experiment-completed","chat-message","error"].forEach(e=>{this.socket.on(e,t=>{this.emit(e,t)})})}handleReconnection(){this.reconnectAttempts<this.maxReconnectAttempts?(this.reconnectAttempts++,console.log(`Attempting to reconnect (${this.reconnectAttempts}/${this.maxReconnectAttempts})`),this.emit("reconnecting",{attempt:this.reconnectAttempts,maxAttempts:this.maxReconnectAttempts}),setTimeout(()=>{this.socket.connect()},i.server.reconnectDelay*this.reconnectAttempts)):(console.error("Max reconnection attempts reached"),this.emit("error",{message:"Connection lost. Please refresh the page or try reconnecting.",type:"connection_lost",canRetry:!0}))}async retryConnection(){if(this.socket&&!this.isConnected){console.log("Manually retrying connection..."),this.reconnectAttempts=0;try{return await this.connect(),!0}catch(n){return console.error("Manual reconnection failed:",n),!1}}return!1}async joinRoom(n={}){return new Promise((e,t)=>{const a=setTimeout(()=>{t(new Error("Join room timeout"))},1e4);this.socket.once("room-joined",r=>{clearTimeout(a),e(r)}),this.socket.once("error",r=>{clearTimeout(a),t(r)}),this.socket.emit("join-room",n)})}setPlayerReady(){this.isConnected&&this.socket.emit("player-ready")}setMatchPlayReady(){this.isConnected&&this.socket.emit("match-play-ready")}sendGameAction(n){this.isConnected&&this.socket.emit("game-action",{action:n})}syncGameState(n){this.isConnected&&this.socket.emit("sync-game-state",n)}sendTrialComplete(n){this.isConnected&&this.socket.emit("trial-complete",n)}sendExperimentComplete(n){this.isConnected&&this.socket.emit("experiment-complete",n)}sendChatMessage(n){this.isConnected&&this.socket.emit("chat-message",n)}on(n,e){this.eventHandlers.has(n)||this.eventHandlers.set(n,[]),this.eventHandlers.get(n).push(e)}off(n,e){if(this.eventHandlers.has(n)){const t=this.eventHandlers.get(n),a=t.indexOf(e);a>-1&&t.splice(a,1)}}emit(n,e){this.eventHandlers.has(n)&&this.eventHandlers.get(n).forEach(t=>{try{t(e)}catch(a){console.error(`Error in event handler for ${n}:`,a)}})}disconnect(){this.socket&&(this.socket.disconnect(),this.socket=null),this.isConnected=!1}}const I={isValidPosition(P){if(!P||!Array.isArray(P)||P.length<2)return!1;const[n,e]=P;return n>=0&&n<i.game.matrixSize&&e>=0&&e<i.game.matrixSize},isValidMove(P,n,e){const t=this.transition(n,e);if(!this.isValidPosition(t))return[0,0];const[a,r]=t;return P[a][r]===$.obstacle?[0,0]:e},transition(P,n){const[e,t]=P;return[e+n[0],t+n[1]]},calculateGridDistance(P,n){return!P||!n||!Array.isArray(P)||!Array.isArray(n)||P.length<2||n.length<2?1/0:Math.abs(P[0]-n[0])+Math.abs(P[1]-n[1])},isGoalReached(P,n){if(!P||!n||!Array.isArray(n))return!1;for(let e=0;e<n.length;e++)if(P[0]===n[e][0]&&P[1]===n[e][1])return!0;return!1},whichGoalReached(P,n){for(let e=0;e<n.length;e++)if(this.isGoalReached(P,[n[e]]))return e;return null},detectPlayerGoal(P,n,e,t){if(!n)return null;let a;if(typeof n=="string")switch(n){case"up":a=[-1,0];break;case"down":a=[1,0];break;case"left":a=[0,-1];break;case"right":a=[0,1];break;default:return null}else if(Array.isArray(n))a=n;else return null;if(a[0]===0&&a[1]===0)return null;const r=this.transition(P,a);let s=1/0,o=null;const l=[];for(let c=0;c<e.length;c++){const h=this.calculateGridDistance(r,e[c]);h<s?(s=h,o=c,l.length=0,l.push(c)):h===s&&l.push(c)}return l.length>1?t&&t.length>0?t[t.length-1]:null:o},updateMatrix(P,n,e,t){const a=P.map(r=>[...r]);return n>=0&&n<a.length&&e>=0&&e<a[0].length&&(a[n][e]=t),a},generateRandomPosition(P=[]){const n=i.game.matrixSize;let e,t=0;const a=100;do e=[Math.floor(Math.random()*n),Math.floor(Math.random()*n)],t++;while(t<a&&P.some(r=>r[0]===e[0]&&r[1]===e[1]));return e},createFallbackDesign(P){switch(console.log("Creating fallback design for:",P),P){case"1P1G":return{initPlayerGrid:[7,2],target1:[7,12],mapType:"1P1G"};case"1P2G":return{initPlayerGrid:[7,7],target1:[2,7],target2:[12,7],mapType:"1P2G"};case"2P2G":return{initPlayerGrid:[7,2],initAIGrid:[7,12],target1:[2,7],target2:[12,7],mapType:"2P2G"};case"2P3G":return{initPlayerGrid:[7,2],initAIGrid:[7,12],target1:[2,7],target2:[12,7],mapType:"2P3G"};default:return console.error("No fallback design for experiment type:",P),null}},calculateSuccessRate(P){if(!P||P.length===0)return 0;const n=P.filter(e=>e.collaborationSucceeded===!0||e.completed===!0).length;return Math.round(n/P.length*100)},formatDuration(P){const n=Math.floor(P/1e3),e=Math.floor(n/60),t=n%60;return e>0?`${e}:${t.toString().padStart(2,"0")}`:`${t}s`},deepClone(P){if(P===null||typeof P!="object")return P;if(P instanceof Date)return new Date(P);if(P instanceof Array)return P.map(n=>this.deepClone(n));if(typeof P=="object"){const n={};for(const e in P)P.hasOwnProperty(e)&&(n[e]=this.deepClone(P[e]));return n}}};class zn{constructor(){this.currentState=null,this.trialData=null,this.experimentData=null,this.isMoving=!1,this.gameStartTime=0,this.stepCount=0,this.conditionSequences={},this.lastMoveTime=new Map,this.lastLocalMoveTime=new Map,this.moveCounter=0,this.lastSyncTime=0,this.syncPending=!1,this.reset()}reset(){this.currentState={gridMatrix:null,player1:null,player2:null,currentGoals:[],experimentType:null,trialIndex:0,gameMode:"human-ai"},this.clearRealTimeSync(),this.trialData={trialIndex:0,experimentType:null,partnerAgentType:null,distanceCondition:null,gptErrorEvents:[],player1Trajectory:[],player2Trajectory:[],player1Actions:[],player2Actions:[],player1RT:[],player2RT:[],aiInferredOtherGoals:[],currentPlayerIndex:[],player1StartPosition:null,player2StartPosition:null,initialGoalPositions:[],trialStartTime:0,player1GoalReachedStep:-1,player2GoalReachedStep:-1,player1CurrentGoal:[],player2CurrentGoal:[],player1FirstDetectedGoal:null,player2FirstDetectedGoal:null,player1FinalReachedGoal:null,player2FinalReachedGoal:null,firstDetectedSharedGoal:null,newGoalPresentedTime:null,newGoalPosition:null,newGoalConditionType:null,newGoalPresented:!1,isNewGoalCloserToPlayer2:null,collaborationSucceeded:void 0,partnerFallbackOccurred:!1,partnerFallbackReason:null,partnerFallbackStage:null,partnerFallbackTime:null,partnerFallbackAIType:null,humanPlayerIndex:null,aiPlayerIndex:null},this.experimentData={allTrialsData:[],currentExperiment:null,successThreshold:{consecutiveSuccesses:0,totalTrialsCompleted:0,experimentEndedEarly:!1,lastSuccessTrial:-1,successHistory:[]},fallbackEvents:[]},this.stepCount=0,this.gameStartTime=0,this.isMoving=!1,this.conditionSequences={}}initializeTrial(n,e,t){var a,r,s,o,l,c,h,d;this.trialData.trialIndex=n,this.trialData.experimentType=e,this.trialData.partnerAgentType=this.getPartnerAgentType(e),this.trialData.trialStartTime=Date.now(),this.gameStartTime=Date.now(),this.stepCount=0,this.isMoving=!1,this.trialData.player1Trajectory=[],this.trialData.player2Trajectory=[],this.trialData.player1Actions=[],this.trialData.player2Actions=[],this.trialData.player1RT=[],this.trialData.player2RT=[],this.trialData.currentPlayerIndex=[],this.trialData.gptErrorEvents=[],this.trialData.player1StartPosition=null,this.trialData.player2StartPosition=null,this.trialData.initialGoalPositions=[],this.trialData.player1CurrentGoal=[],this.trialData.player2CurrentGoal=[],this.trialData.player1FirstDetectedGoal=null,this.trialData.player2FirstDetectedGoal=null,this.trialData.player1FinalReachedGoal=null,this.trialData.player2FinalReachedGoal=null,this.trialData.firstDetectedSharedGoal=null,this.trialData.player1GoalReachedStep=-1,this.trialData.player2GoalReachedStep=-1,this.trialData.newGoalPresentedTime=null,this.trialData.newGoalPosition=null,this.trialData.newGoalConditionType=null,this.trialData.distanceCondition=null,this.trialData.newGoalPresented=!1,this.trialData.isNewGoalCloserToPlayer2=null,this.trialData.collaborationSucceeded=void 0,this.trialData._finalized=!1,this.trialData.partnerFallbackOccurred=!1,this.trialData.partnerFallbackReason=null,this.trialData.partnerFallbackStage=null,this.trialData.partnerFallbackTime=null;try{if(String(e||"").includes("2P")){const g=(s=(r=(a=i==null?void 0:i.game)==null?void 0:a.players)==null?void 0:r.player1)==null?void 0:s.type,x=(c=(l=(o=i==null?void 0:i.game)==null?void 0:o.players)==null?void 0:l.player2)==null?void 0:c.type;g==="human"&&x!=="human"?(this.trialData.humanPlayerIndex=0,this.trialData.aiPlayerIndex=1):x==="human"&&g!=="human"?(this.trialData.humanPlayerIndex=1,this.trialData.aiPlayerIndex=0):(this.trialData.humanPlayerIndex=null,this.trialData.aiPlayerIndex=null)}else this.trialData.humanPlayerIndex=0,this.trialData.aiPlayerIndex=null}catch{}if(e==="2P3G"){const g=this.getRandomDistanceConditionFor2P3G(n);this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}else if(e==="1P2G"){const g=this.getRandomDistanceConditionFor1P2G(n);this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}else if(e==="2P2G"){const g=(d=(h=i==null?void 0:i.twoP3G)==null?void 0:h.distanceConditions)==null?void 0:d.NO_NEW_GOAL;this.trialData.newGoalConditionType=g,this.trialData.distanceCondition=g,this.currentState.newGoalConditionType=g,this.currentState.distanceCondition=g}(e==="1P2G"||e==="2P3G")&&(console.log(`🗺️ Starting ${e} trial ${n}: new-goal condition =`,this.trialData.distanceCondition),console.log(`🤝 Partner agent type: ${this.trialData.partnerAgentType}`)),this.setupGridMatrix(t,e),this.currentState.experimentType=e,this.currentState.trialIndex=n;try{this.trialData.player1StartPosition=Array.isArray(this.currentState.player1)&&this.currentState.player1.length>=2?[...this.currentState.player1]:null,this.trialData.player2StartPosition=Array.isArray(this.currentState.player2)&&this.currentState.player2.length>=2?[...this.currentState.player2]:null,Array.isArray(this.currentState.currentGoals)?this.trialData.initialGoalPositions=this.currentState.currentGoals.filter(g=>Array.isArray(g)&&g.length>=2).map(g=>[...g]):this.trialData.initialGoalPositions=[]}catch{}}recordPartnerFallback({reason:n="disconnect",stage:e="in-game",at:t=Date.now(),fallbackAIType:a=null}={}){var r,s,o,l,c,h,d,g,x,p,m,u,T;try{let G="unknown";if(a)G=this.normalizeAITypeName(a);else try{const y=(o=(s=(r=i==null?void 0:i.game)==null?void 0:r.players)==null?void 0:s.player1)==null?void 0:o.type,f=(h=(c=(l=i==null?void 0:i.game)==null?void 0:l.players)==null?void 0:c.player2)==null?void 0:h.type,b=y!=="human"?y:f!=="human"?f:null;if(b==="gpt"){const v=(x=(g=(d=i==null?void 0:i.game)==null?void 0:d.agent)==null?void 0:g.gpt)==null?void 0:x.model;v&&String(v).trim().length>0?G=String(v):(console.warn("⚠️ GPT model not cached in CONFIG for fallback recording, using configured default"),G="gpt-4o")}else if(b==="rl_joint")G="joint-rl";else if(b==="rl_individual")G="individual-rl";else if(b==="ai")G=((m=(p=i==null?void 0:i.game)==null?void 0:p.agent)==null?void 0:m.type)==="individual"?"individual-rl":"joint-rl";else if(b&&b!=="human")G=String(b);else{const v=((u=i==null?void 0:i.multiplayer)==null?void 0:u.fallbackAIType)||"rl_joint";G=this.normalizeAITypeName(v)}}catch{const f=((T=i==null?void 0:i.multiplayer)==null?void 0:T.fallbackAIType)||"rl_joint";G=this.normalizeAITypeName(f)}if(this.trialData&&(this.trialData.partnerFallbackOccurred=!0,this.trialData.partnerFallbackReason=n,this.trialData.partnerFallbackStage=e,this.trialData.partnerFallbackTime=t,this.trialData.partnerFallbackAIType=G),this.experimentData){const y=this.currentState&&Number.isInteger(this.currentState.trialIndex)?this.currentState.trialIndex:-1,f=this.currentState&&this.currentState.experimentType||null,b={reason:n,stage:e,at:t,trialIndex:y,experimentType:f,aiType:G};Array.isArray(this.experimentData.fallbackEvents)?this.experimentData.fallbackEvents.push(b):this.experimentData.fallbackEvents=[b]}}catch{}}recordGptErrorEvent({phase:n="independent",error:e="",humanDirection:t=null,fallback:a=null,fallbackDirection:r=null}={}){try{const s={step:this.stepCount,timeMs:Date.now()-(this.gameStartTime||Date.now()),phase:n,error:String(e||""),humanDirection:t||null,fallback:a||null,fallbackDirection:r||null};Array.isArray(this.trialData.gptErrorEvents)?this.trialData.gptErrorEvents.push(s):this.trialData.gptErrorEvents=[s]}catch{}}setupGridMatrix(n,e){if(!n){console.error("Invalid design provided to setupGridMatrix:",n);return}const t=i.game.matrixSize;if(this.currentState.gridMatrix=Array(t).fill(0).map(()=>Array(t).fill(0)),n.initPlayerGrid&&n.initPlayerGrid.length>=2){const[a,r]=n.initPlayerGrid;this.currentState.gridMatrix[a][r]=$.player,this.currentState.player1=[a,r]}if(e&&e.includes("2P")&&n.initAIGrid&&n.initAIGrid.length>=2){const[a,r]=n.initAIGrid;this.currentState.gridMatrix[a][r]=$.ai_player,this.currentState.player2=[a,r]}else this.currentState.player2=null;if(this.currentState.currentGoals=[],n.target1&&n.target1.length>=2){const[a,r]=n.target1;this.currentState.gridMatrix[a][r]=$.goal,this.currentState.currentGoals.push([a,r])}if(n.target2&&n.target2.length>=2){const[a,r]=n.target2;this.currentState.gridMatrix[a][r]=$.goal,this.currentState.currentGoals.push([a,r])}}addGoal(n){if(!n||n.length<2)return;const[e,t]=n;if(!(!this.currentState||!this.currentState.gridMatrix)&&!(e<0||e>=this.currentState.gridMatrix.length)&&!(t<0||t>=this.currentState.gridMatrix[0].length)){if(this.currentState.currentGoals.some(a=>a[0]===e&&a[1]===t)){console.log(`🔧 [GOAL] Duplicate goal at [${e}, ${t}] not added`);return}console.log(`🎯 [GOAL] Adding goal at [${e}, ${t}]. Total goals: ${this.currentState.currentGoals.length+1}`),this.currentState.gridMatrix[e][t]=$.goal,this.currentState.currentGoals.push([e,t])}}markNewGoalPresented(n,e,t={}){if(!this.trialData)return;this.trialData.newGoalPresented=!0,this.trialData.newGoalPresentedTime=this.stepCount,this.trialData.newGoalPosition=n?[...n]:null;const a=e||this.trialData.newGoalConditionType||this.trialData.distanceCondition||null;this.trialData.newGoalConditionType=a,this.trialData.distanceCondition=a,this.currentState&&(this.currentState.newGoalConditionType=a,this.currentState.distanceCondition=a),typeof t.isNewGoalCloserToPlayer2=="boolean"&&(this.trialData.isNewGoalCloserToPlayer2=t.isNewGoalCloserToPlayer2)}processPlayerMove(n,e,t=null){var r;if(this.isMoving)return{success:!1,reason:"already_moving"};const a=n===1?this.currentState.player1:this.currentState.player2;if(!a)return{success:!1,reason:"invalid_player"};if(I.isGoalReached(a,this.currentState.currentGoals))return{success:!1,reason:"already_at_goal"};this.isMoving=!0;try{const s=(r=rn[`arrow${e}`])==null?void 0:r.movement;if(!s)return{success:!1,reason:"invalid_direction"};(this.gameStartTime===0||Date.now()-this.gameStartTime>6e4)&&(console.warn("Invalid gameStartTime detected, resetting to current time"),this.gameStartTime=Date.now());const o=Date.now()-this.gameStartTime;this.recordPlayerMove(n,s,o,t);const l=I.isValidMove(this.currentState.gridMatrix,a,s),c=I.transition(a,l);return this.updatePlayerPosition(n,a,c),this.detectAndRecordGoals(n,s),this.stepCount++,{success:!0,trialComplete:this.checkTrialCompletion(),newPosition:c,stepCount:this.stepCount}}finally{setTimeout(()=>{this.isMoving=!1},100)}}processSynchronizedMoves(n,e){var t,a;if(this.isMoving)return{success:!1,reason:"already_moving"};this.isMoving=!0;try{const r={success:!0,trialComplete:!1},s=this.currentState.player1,o=this.currentState.player2,l=n?(t=rn[`arrow${n}`])==null?void 0:t.movement:null,c=e?(a=rn[`arrow${e}`])==null?void 0:a.movement:null,h=Date.now()-this.gameStartTime;let d=s;if(s&&l&&!I.isGoalReached(s,this.currentState.currentGoals)){this.recordPlayerMove(1,l,h);const x=I.isValidMove(this.currentState.gridMatrix,s,l);d=I.transition(s,x)}let g=o;if(o&&c&&!I.isGoalReached(o,this.currentState.currentGoals)){this.recordPlayerMove(2,c,h);const x=I.isValidMove(this.currentState.gridMatrix,o,c);g=I.transition(o,x)}return s&&d&&d!==s&&this.updatePlayerPosition(1,s,d),o&&g&&g!==o&&this.updatePlayerPosition(2,o,g),s&&l&&this.detectAndRecordGoals(1,l),o&&c&&this.detectAndRecordGoals(2,c),this.stepCount++,r.trialComplete=this.checkTrialCompletion(),r.newPositions={player1:d,player2:g},r}finally{setTimeout(()=>{this.isMoving=!1},100)}}processSynchronizedMovesMapped(n,e,t){var a,r;if(this.isMoving)return{success:!1,reason:"already_moving"};this.isMoving=!0;try{const s={success:!0,trialComplete:!1},o=this.currentState.player1,l=this.currentState.player2,c=e?(a=rn[`arrow${e}`])==null?void 0:a.movement:null,h=t?(r=rn[`arrow${t}`])==null?void 0:r.movement:null,d=n===1?c:h,g=n===2?c:h,x=Date.now()-this.gameStartTime;let p=o;if(o&&d&&!I.isGoalReached(o,this.currentState.currentGoals)){this.recordPlayerMove(1,d,x);const u=I.isValidMove(this.currentState.gridMatrix,o,d);p=I.transition(o,u)}let m=l;if(l&&g&&!I.isGoalReached(l,this.currentState.currentGoals)){this.recordPlayerMove(2,g,x);const u=I.isValidMove(this.currentState.gridMatrix,l,g);m=I.transition(l,u)}return o&&p&&p!==o&&this.updatePlayerPosition(1,o,p),l&&m&&m!==l&&this.updatePlayerPosition(2,l,m),o&&d&&this.detectAndRecordGoals(1,d),l&&g&&this.detectAndRecordGoals(2,g),this.stepCount++,s.trialComplete=this.checkTrialCompletion(),s}finally{setTimeout(()=>{this.isMoving=!1},100)}}updatePlayerPosition(n,e,t){const a=n===1?$.player:$.ai_player;this.currentState.gridMatrix[e[0]][e[1]]=$.blank,this.currentState.gridMatrix[t[0]][t[1]]=a,n===1?this.currentState.player1=[...t]:this.currentState.player2=[...t]}recordPlayerMove(n,e,t,a=null){const r=n===1?this.currentState.player1:this.currentState.player2;n===1?(this.trialData.player1Actions.push(e),this.trialData.player1Trajectory.push([...r]),this.trialData.player1RT.push(t)):(this.trialData.player2Actions.push(e),this.trialData.player2Trajectory.push([...r]),this.trialData.player2RT.push(t)),a!==null?this.trialData.currentPlayerIndex.push(a):this.trialData.currentPlayerIndex.push(n===1?0:1)}recordAIInferredOtherGoal(n){try{Array.isArray(this.trialData.aiInferredOtherGoals)||(this.trialData.aiInferredOtherGoals=[]),this.trialData.aiInferredOtherGoals.push(Array.isArray(n)&&n.length>=2?[n[0],n[1]]:null)}catch{}}detectAndRecordGoals(n,e){const t=n===1?this.currentState.player1:this.currentState.player2,a=n===1?this.trialData.player1CurrentGoal:this.trialData.player2CurrentGoal,r=I.detectPlayerGoal(t,e,this.currentState.currentGoals,a);if(n===1?(this.trialData.player1CurrentGoal.push(r),r!==null&&this.trialData.player1FirstDetectedGoal===null&&(this.trialData.player1FirstDetectedGoal=r)):(this.trialData.player2CurrentGoal.push(r),r!==null&&this.trialData.player2FirstDetectedGoal===null&&(this.trialData.player2FirstDetectedGoal=r)),this.currentState.experimentType==="2P3G"&&this.trialData.player1CurrentGoal.length>0&&this.trialData.player2CurrentGoal.length>0){const s=this.trialData.player1CurrentGoal[this.trialData.player1CurrentGoal.length-1],o=this.trialData.player2CurrentGoal[this.trialData.player2CurrentGoal.length-1];s!==null&&o!==null&&s===o&&this.trialData.firstDetectedSharedGoal===null&&(this.trialData.firstDetectedSharedGoal=s)}}checkTrialCompletion(){const n=I.isGoalReached(this.currentState.player1,this.currentState.currentGoals),e=this.currentState.player2?I.isGoalReached(this.currentState.player2,this.currentState.currentGoals):!0;if(n&&this.trialData.player1GoalReachedStep===-1&&(this.trialData.player1GoalReachedStep=this.stepCount,this.trialData.player1FinalReachedGoal=I.whichGoalReached(this.currentState.player1,this.currentState.currentGoals)),this.currentState.player2&&e&&this.trialData.player2GoalReachedStep===-1&&(this.trialData.player2GoalReachedStep=this.stepCount,this.trialData.player2FinalReachedGoal=I.whichGoalReached(this.currentState.player2,this.currentState.currentGoals)),this.currentState.experimentType.startsWith("1P"))return n;if(n&&e){const t=this.trialData.player1FinalReachedGoal,a=this.trialData.player2FinalReachedGoal;return this.trialData.collaborationSucceeded=t===a&&t!==null,!0}return this.stepCount>=i.game.maxGameLength}finalizeTrial(n){var e,t,a,r;if(this.trialData._finalized){console.warn("Trial already finalized, skipping duplicate finalization");return}try{this.currentState&&typeof this.currentState.experimentType=="string"&&this.currentState.experimentType.includes("2P")&&typeof this.trialData.collaborationSucceeded!="boolean"&&(this.trialData.collaborationSucceeded=!1)}catch{}this.trialData.completed=!!n,this.trialData.endTime=Date.now(),this.trialData.totalSteps=this.stepCount;try{if(this.currentState&&String(this.currentState.experimentType||"").includes("2P")){const o=String(this.trialData.partnerAgentType||"").trim(),l=this.getPartnerAgentType(this.currentState.experimentType);l&&o!==l&&(this.trialData.partnerAgentType=l);const c=(a=(t=(e=i==null?void 0:i.game)==null?void 0:e.agent)==null?void 0:t.gpt)==null?void 0:a.model;this.trialData.partnerFallbackOccurred&&c&&/^gpt$/i.test(String(this.trialData.partnerFallbackAIType||""))&&(this.trialData.partnerFallbackAIType=c)}}catch{}try{if(this.trialData.newGoalPresented&&(!this.trialData.newGoalPosition||this.trialData.newGoalPosition.length<2)){const s=Array.isArray((r=this.currentState)==null?void 0:r.currentGoals)?this.currentState.currentGoals:[];if(s.length>=3){const o=s[s.length-1];Array.isArray(o)&&o.length>=2&&(this.trialData.newGoalPosition=[o[0],o[1]])}}}catch{}this.fixMissingGoalValues(),this.experimentData.allTrialsData.push({...this.trialData}),this.trialData._finalized=!0,this.updateSuccessThreshold(n)}fixMissingGoalValues(){var e;const n=((e=this.currentState)==null?void 0:e.experimentType)||"";n.startsWith("1P")?this.trialData.player2FinalReachedGoal=-1:n.startsWith("2P")&&(this.trialData.player1GoalReachedStep===-1&&this.trialData.player1FinalReachedGoal===null&&(this.trialData.player1FinalReachedGoal=-1),this.trialData.player2GoalReachedStep===-1&&this.trialData.player2FinalReachedGoal===null&&(this.trialData.player2FinalReachedGoal=-1))}normalizeAITypeName(n){var t,a,r,s,o,l,c,h,d;if(!n||typeof n!="string")return"unknown";switch(n.toLowerCase().trim()){case"gpt":const g=(r=(a=(t=i==null?void 0:i.game)==null?void 0:t.agent)==null?void 0:a.gpt)==null?void 0:r.model;return g&&String(g).trim()?String(g):"gpt-4o";case"rl_joint":case"joint":return"joint-rl";case"rl_individual":case"individual":return"individual-rl";case"ai":return((o=(s=i==null?void 0:i.game)==null?void 0:s.agent)==null?void 0:o.type)==="individual"?"individual-rl":"joint-rl";case"human":console.error('❌ BUG: Attempted to set partnerFallbackAIType to "human" - using default instead');const x=((l=i==null?void 0:i.multiplayer)==null?void 0:l.fallbackAIType)||"rl_joint";if(x==="rl_joint")return"joint-rl";if(x==="rl_individual")return"individual-rl";if(x==="gpt"){const p=(d=(h=(c=i==null?void 0:i.game)==null?void 0:c.agent)==null?void 0:h.gpt)==null?void 0:d.model;return p&&String(p).trim()?String(p):"gpt-4o"}return"joint-rl";default:return n}}updateSuccessThreshold(n){const e=this.experimentData.successThreshold;e.totalTrialsCompleted++,e.successHistory.push(n),n?(e.consecutiveSuccesses++,e.lastSuccessTrial=e.totalTrialsCompleted-1):e.consecutiveSuccesses=0,e.consecutiveSuccesses>=i.game.successThreshold.consecutiveSuccessesRequired&&e.totalTrialsCompleted>=i.game.successThreshold.minTrialsBeforeCheck&&(e.experimentEndedEarly=!0)}getPartnerAgentType(n){var e,t,a,r,s,o,l,c,h,d,g;try{if(!String(n||"").includes("2P"))return"none";const x=(a=(t=(e=i==null?void 0:i.game)==null?void 0:e.players)==null?void 0:t.player1)==null?void 0:a.type,p=(o=(s=(r=i==null?void 0:i.game)==null?void 0:r.players)==null?void 0:s.player2)==null?void 0:o.type,m=x!=="human"?x:p!=="human"?p:"human";if(m==="human")return"human";if(m==="gpt"){const u=(h=(c=(l=i==null?void 0:i.game)==null?void 0:l.agent)==null?void 0:c.gpt)==null?void 0:h.model;return u&&String(u).trim().length>0?String(u):(console.warn("⚠️ GPT model not cached in CONFIG, using fallback logic"),"gpt-4o")}return m==="rl_joint"?"joint-rl":m==="rl_individual"?"individual-rl":m==="ai"?((g=(d=i==null?void 0:i.game)==null?void 0:d.agent)==null?void 0:g.type)==="individual"?"individual-rl":"joint-rl":String(m||"unknown")}catch{return"unknown"}}getSessionSeedInt(){try{if(typeof window<"u"&&Number.isInteger(window.__SESSION_SEED__))return window.__SESSION_SEED__}catch{}return null}seededShuffle(n,e){if(!Array.isArray(n)||n.length<=1)return n;if(!Number.isInteger(e))return this.randomShuffle(n);const t=n.slice();let a=e>>>0||1;const r=4294967296,s=1664525,o=1013904223,l=()=>(a=Math.imul(s,a)+o>>>0,a/r);for(let c=t.length-1;c>0;c--){const h=Math.floor(l()*(c+1));[t[c],t[h]]=[t[h],t[c]]}return t}randomShuffle(n){const e=n.slice();for(let t=e.length-1;t>0;t--){const a=Math.floor(Math.random()*(t+1));[e[t],e[a]]=[e[a],e[t]]}return e}getRandomDistanceConditionFor2P3G(n){var r,s,o,l,c;const e="2P3G",t=(s=(r=i.game.experiments)==null?void 0:r.numTrials)==null?void 0:s[e];if(!this.conditionSequences[e]){const d=((c=(l=(o=i==null?void 0:i.game)==null?void 0:o.players)==null?void 0:l.player2)==null?void 0:c.type)==="human"?this.getSessionSeedInt()??null:null;this.conditionSequences[e]=this.generateBalancedConditionSequence(Object.values(i.twoP3G.distanceConditions),t,d),console.log(`🎲 Generated balanced condition sequence for ${e}:`,this.conditionSequences[e])}const a=this.conditionSequences[e];return a[n%a.length]}getRandomDistanceConditionFor1P2G(n){var r,s;const e="1P2G",t=(s=(r=i.game.experiments)==null?void 0:r.numTrials)==null?void 0:s[e];this.conditionSequences[e]||(this.conditionSequences[e]=this.generateBalancedConditionSequence(Object.values(i.oneP2G.distanceConditions),t),console.log(`🎲 Generated balanced condition sequence for ${e}:`,this.conditionSequences[e]));const a=this.conditionSequences[e];return a[n%a.length]}generateBalancedConditionSequence(n,e,t=null){if(!Array.isArray(n)||n.length===0||e<=0)return[];const a=n.length,r=Math.floor(e/a);let s=e%a;const o=[];for(let d=0;d<a;d++)for(let g=0;g<r;g++)o.push(n[d]);let l=[...Array(a).keys()];l=Number.isInteger(t)?this.seededShuffle(l,t):this.randomShuffle(l);let c=0;for(;s>0;)o.push(n[l[c%a]]),c++,s--;return Number.isInteger(t)?this.seededShuffle(o,t^2654435769):this.randomShuffle(o)}syncState(n){var r,s,o,l,c;try{const h=Array.isArray((r=this.currentState)==null?void 0:r.currentGoals)?this.currentState.currentGoals:[],d=Array.isArray(n==null?void 0:n.currentGoals)?n.currentGoals:null;if(d&&Array.isArray(d)&&Array.isArray(h)&&d.length>h.length&&(((s=this.currentState)==null?void 0:s.experimentType)==="2P3G"||(n==null?void 0:n.experimentType)==="2P3G")&&this.trialData&&this.trialData.newGoalPresented===!1){const g=(p,m)=>Array.isArray(p)&&Array.isArray(m)&&p[0]===m[0]&&p[1]===m[1],x=d.find(p=>!h.some(m=>g(m,p)));if(Array.isArray(x)&&x.length===2){const p=n&&(n.distanceCondition||n.newGoalConditionType)||this.trialData.distanceCondition||this.trialData.newGoalConditionType||null;this.markNewGoalPresented([...x],p,{})}}}catch{}const e={...this.currentState,...n},t=i.multiplayer.realTimeMovement,a=Date.now();if(t&&this.currentState&&[1,2].forEach(h=>{const d=`player${h}`,g=this.currentState[d],x=n[d];if(g&&x){const p=this.lastMoveTime.get(h)||0,m=a-p,u=t.localMoveProtectionWindow;if(m<u&&(console.log(`🔧 [ROLLBACK FIX] Preserving local position for player${h} (moved ${m}ms ago)`),e[d]=g,e.gridMatrix&&Array.isArray(g)&&g.length===2)){const[T,G]=g;T>=0&&T<e.gridMatrix.length&&G>=0&&G<e.gridMatrix[0].length&&(Array.isArray(x)&&(x[0]!==g[0]||x[1]!==g[1])&&(e.gridMatrix[x[0]][x[1]]=$.blank),e.gridMatrix[T][G]=h)}}}),((o=this.currentState)==null?void 0:o.experimentType)==="2P3G"||(n==null?void 0:n.experimentType)==="2P3G"){const h=Array.isArray((l=this.currentState)==null?void 0:l.currentGoals)?this.currentState.currentGoals:[],d=Array.isArray(n==null?void 0:n.currentGoals)?n.currentGoals:[];h.length>d.length?(console.log(`🔧 [SYNC FIX] Preserving local goals (${h.length}) over remote goals (${d.length})`),e.currentGoals=h,(c=this.currentState)!=null&&c.gridMatrix&&(e.gridMatrix=this.currentState.gridMatrix)):d.length>h.length&&(console.log(`🔧 [SYNC FIX] Accepting remote goals (${d.length}) over local goals (${h.length})`),n!=null&&n.gridMatrix&&(e.gridMatrix=n.gridMatrix))}this.currentState=e}getCurrentState(){return{...this.currentState}}processPlayerMoveRealTime(n,e,t=Date.now(),a=!1,r=null){const s=i.multiplayer.realTimeMovement,o=this.lastMoveTime.get(n)||0;if(t-o<s.moveThrottleDelay)return{success:!1,reason:"throttled"};this.lastMoveTime.set(n,t),a&&this.lastLocalMoveTime.set(n,t);const l=this.isMoving;let c;try{this.isMoving=!1,c=this.processPlayerMove(n,e,r)}finally{this.isMoving=l}return c.timestamp=t,c.isLocal=a,c.moveId=`move_${this.moveCounter++}_${n}_${t}`,c}shouldSyncState(){const n=i.multiplayer.realTimeMovement;return Date.now()-this.lastSyncTime>n.stateSyncInterval}hasRecentLocalMoves(){const n=Date.now(),e=250;for(const[t,a]of this.lastLocalMoveTime.entries())if(n-a<e)return!0;return!1}markStateSynced(){this.lastSyncTime=Date.now()}clearRealTimeSync(){this.lastMoveTime.clear(),this.lastLocalMoveTime.clear(),this.moveCounter=0,this.lastSyncTime=0,this.syncPending=!1}getCurrentTrialData(){return{...this.trialData}}getTrialData(){return{...this.trialData}}getExperimentData(){return{...this.experimentData}}}class $n{constructor(){this.canvas=null,this.ctx=null,this.cellSize=i.visual.cellSize,this.canvasSize=i.visual.canvasSize,this.padding=i.visual.padding,this.effectiveCellSize=this.cellSize+this.padding}createCanvas(){this.canvas=document.createElement("canvas"),this.canvas.width=this.canvasSize,this.canvas.height=this.canvasSize,this.canvas.style.border="2px solid #333",this.canvas.style.backgroundColor=i.visual.colors.background,this.ctx=this.canvas.getContext("2d");try{this.applyResponsiveSizing()}catch{}return this.canvas}applyResponsiveSizing(){if(!this.canvas)return;const n=i.game.matrixSize,e=typeof window<"u"&&window.devicePixelRatio?window.devicePixelRatio:1,t=this.canvas.parentElement,a=typeof window<"u"?Math.min(window.innerWidth||0,window.innerHeight||0):this.canvasSize,r=t?t.clientWidth:a,s=Math.max(200,Math.floor(Math.min(a*.85,r-16)));let o=Math.floor((s-(n+1)*this.padding)/n);o=Math.max(10,o);const l=n*o+(n+1)*this.padding;this.cellSize=o,this.effectiveCellSize=this.cellSize+this.padding,this.canvasSize=l,this.canvas.style.width=`${l}px`,this.canvas.style.height=`${l}px`;const c=Math.floor(l*e);(this.canvas.width!==c||this.canvas.height!==c)&&(this.canvas.width=c,this.canvas.height=c),this.ctx||(this.ctx=this.canvas.getContext("2d")),this.ctx&&typeof this.ctx.setTransform=="function"&&this.ctx.setTransform(e,0,0,e,0,0)}render(n,e){!n||!e||!e.gridMatrix||(this.canvas=n,this.ctx=n.getContext("2d"),this.gameState=e,this.applyResponsiveSizing(),this.ctx.fillStyle=i.visual.colors.grid,this.ctx.fillRect(0-this.padding,0-this.padding,this.canvasSize+this.padding,this.canvasSize+this.padding),this.drawGrid(),this.drawGameObjects(e.gridMatrix))}drawGrid(){const n=i.game.matrixSize;for(let e=0;e<n;e++)for(let t=0;t<n;t++)this.ctx.fillStyle=i.visual.colors.background,this.ctx.fillRect(t*this.effectiveCellSize+this.padding,e*this.effectiveCellSize+this.padding,this.cellSize,this.cellSize)}drawGameObjects(n){const e=i.game.matrixSize;for(let a=0;a<e;a++)for(let r=0;r<e;r++){const s=n[a][r];s===$.obstacle&&this.drawCell(a,r,s)}this.drawGoals();const t=this.getPlayerPositions(n);this.drawPlayersWithOverlap(t)}drawGoals(){if(this.gameState&&this.gameState.currentGoals&&Array.isArray(this.gameState.currentGoals)){for(const n of this.gameState.currentGoals)if(n&&Array.isArray(n)&&n.length>=2){const[e,t]=n;this.drawGoalWithPlayerCheck(e,t)}}else{const n=i.game.matrixSize;for(let e=0;e<n;e++)for(let t=0;t<n;t++)this.gameState.gridMatrix[e][t]===$.goal&&this.drawGoalWithPlayerCheck(e,t)}}drawGoalWithPlayerCheck(n,e){const t=this.isPlayerAtPosition(n,e),a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding;this.ctx.save(),this.ctx.fillStyle=i.visual.colors.goal,t&&(this.ctx.globalAlpha=.7),this.ctx.fillRect(a,r,this.cellSize,this.cellSize),this.ctx.restore()}isPlayerAtPosition(n,e){return this.gameState?!!(this.gameState.player1&&this.gameState.player1.length===2&&this.gameState.player1[0]===n&&this.gameState.player1[1]===e||this.gameState.player2&&this.gameState.player2.length===2&&this.gameState.player2[0]===n&&this.gameState.player2[1]===e):!1}getPlayerPositions(n){const e=i.game.matrixSize,t=[];for(let a=0;a<e;a++)for(let r=0;r<e;r++){const s=n[a][r];(s===$.player||s===$.ai_player)&&t.push({row:a,col:r,type:s})}return this.gameState&&(t.length=0,this.gameState.player1&&this.gameState.player1.length===2&&t.push({row:this.gameState.player1[0],col:this.gameState.player1[1],type:$.player}),this.gameState.player2&&this.gameState.player2.length===2&&t.push({row:this.gameState.player2[0],col:this.gameState.player2[1],type:$.ai_player})),t}drawPlayersWithOverlap(n){const e=new Map;for(const t of n){const a=`${t.row},${t.col}`;e.has(a)||e.set(a,[]),e.get(a).push(t)}for(const[t,a]of e){const[r,s]=t.split(",").map(Number);this.drawOverlappingPlayers(r,s,a)}}drawCell(n,e,t){const a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding;switch(a+this.cellSize/2,r+this.cellSize/2,this.cellSize*.35,this.ctx.save(),t){case $.player:case $.ai_player:break;case $.goal:this.ctx.fillStyle=i.visual.colors.goal,this.ctx.fillRect(a,r,this.cellSize,this.cellSize);break;case $.obstacle:this.ctx.fillStyle=i.visual.colors.obstacle,this.ctx.fillRect(a+2,r+2,this.cellSize-4,this.cellSize-4);break}this.ctx.restore()}drawOverlappingPlayers(n,e,t){const a=e*this.effectiveCellSize+this.padding,r=n*this.effectiveCellSize+this.padding,s=a+this.cellSize/2,o=r+this.cellSize/2,l=this.cellSize*.35,c=this.cellSize*.15;if(this.ctx.save(),t.length===1){const d=t[0].type===$.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=d,this.ctx.beginPath(),this.ctx.arc(s,o,l,0,2*Math.PI),this.ctx.fill()}else if(t.length>=2){const d=t[0].type===$.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=d,this.ctx.beginPath(),this.ctx.arc(s-c,o,l,0,2*Math.PI),this.ctx.fill();const x=t[1].type===$.player?i.visual.colors.player1:i.visual.colors.player2;this.ctx.fillStyle=x,this.ctx.beginPath(),this.ctx.arc(s+c,o,l,0,2*Math.PI),this.ctx.fill()}this.ctx.restore()}highlightCell(n,e,t="#ffff00",a=.3){if(!this.ctx)return;const r=e*this.cellSize,s=n*this.cellSize;this.ctx.save(),this.ctx.fillStyle=t,this.ctx.globalAlpha=a,this.ctx.fillRect(r,s,this.cellSize,this.cellSize),this.ctx.restore()}drawTrajectory(n,e="#ff0000",t=.5){if(!(!this.ctx||!n||n.length<2)){this.ctx.save(),this.ctx.strokeStyle=e,this.ctx.globalAlpha=t,this.ctx.lineWidth=3,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath();for(let a=0;a<n.length;a++){const[r,s]=n[a],o=s*this.cellSize+this.cellSize/2,l=r*this.cellSize+this.cellSize/2;a===0?this.ctx.moveTo(o,l):this.ctx.lineTo(o,l)}this.ctx.stroke(),this.ctx.restore()}}drawNewGoalIndicator(n,e){if(!this.ctx)return;const t=e*this.cellSize,a=n*this.cellSize,r=t+this.cellSize/2,s=a+this.cellSize/2;this.ctx.save();const o=Date.now()*.005,l=(Math.sin(o)+1)*.3+.2;this.ctx.fillStyle="#ffff00",this.ctx.globalAlpha=l,this.ctx.fillRect(t,a,this.cellSize,this.cellSize),this.ctx.globalAlpha=1,this.ctx.fillStyle="#ff0000",this.ctx.font="12px Arial",this.ctx.textAlign="center",this.ctx.fillText("NEW!",r,s-15),this.ctx.restore()}animateMove(n,e,t,a,r,s=200){return new Promise(o=>{if(!this.ctx){o();return}const l=Date.now(),c=e*this.cellSize+this.cellSize/2,h=n*this.cellSize+this.cellSize/2,d=a*this.cellSize+this.cellSize/2,g=t*this.cellSize+this.cellSize/2,x=()=>{const p=Date.now()-l,m=Math.min(p/s,1),u=1-Math.pow(1-m,3),T=c+(d-c)*u,G=h+(g-h)*u;this.ctx.save(),this.ctx.globalAlpha=.8;const y=this.cellSize*.35;r===$.player?this.ctx.fillStyle=i.visual.colors.player1:r===$.ai_player&&(this.ctx.fillStyle=i.visual.colors.player2),this.ctx.beginPath(),this.ctx.arc(T,G,y,0,2*Math.PI),this.ctx.fill(),this.ctx.restore(),m<1?requestAnimationFrame(x):o()};x()})}getCellFromPixel(n,e){const t=Math.floor(n/this.cellSize),a=Math.floor(e/this.cellSize);return a>=0&&a<i.game.matrixSize&&t>=0&&t<i.game.matrixSize?{row:a,col:t}:null}getPixelFromCell(n,e){return{x:e*this.cellSize+this.cellSize/2,y:n*this.cellSize+this.cellSize/2}}}class Hn{constructor(n){this.container=n,this.renderer=new $n,this.eventHandlers=new Map,this.currentScreen=null,this.gameCanvas=null,this.keyboardHandler=null,this.playerIndex=0,this.gameMode="human-ai",this.lastGameState=null,this.handleResize=null}cleanupCanvas(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),this.gameCanvas=null,this.lastGameState=null}on(n,e){this.eventHandlers.has(n)||this.eventHandlers.set(n,[]),this.eventHandlers.get(n).push(e)}off(n,e){if(this.eventHandlers.has(n)){const t=this.eventHandlers.get(n),a=t.indexOf(e);a>-1&&t.splice(a,1)}}emit(n,e){this.eventHandlers.has(n)&&this.eventHandlers.get(n).forEach(t=>{try{t(e)}catch(a){console.error(`Error in UI event handler for ${n}:`,a)}})}setPlayerInfo(n,e){this.playerIndex=n,this.gameMode=e}showMainScreen(){this.cleanupCanvas(),this.currentScreen="main",this.container.innerHTML=`
    ...
    `,this.createGameCanvas(),this.setupKeyboardControls()}createGameCanvas(){const n=document.getElementById("gameCanvas");if(n){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),this.gameCanvas=this.renderer.createCanvas(),n.appendChild(this.gameCanvas);const e=()=>{this.renderer.applyResponsiveSizing(),this.lastGameState&&this.renderer.render(this.gameCanvas,this.lastGameState)};this.handleResize=()=>e(),window.addEventListener("resize",this.handleResize),setTimeout(e,0)}}setupKeyboardControls(){this.keyboardHandler&&document.removeEventListener("keydown",this.keyboardHandler),this.keyboardHandler=n=>{const e=n.code;if(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"].includes(e)){n.preventDefault();const a=e.replace("Arrow","").toLowerCase();this.emit("player-move",a)}},document.addEventListener("keydown",this.keyboardHandler),document.body.focus()}updateLobbyInfo(n){const e=document.getElementById("lobby-info");e&&(e.innerHTML=`
      ...
      `)}updateGameDisplay(n){this.gameCanvas&&n&&(this.lastGameState=n,this.renderer.render(this.gameCanvas,n))}updateGameInfo(n,e,t){const a=document.getElementById("game-title"),r=document.getElementById("trial-info");a&&(a.textContent=`Game ${n+1}`),r&&(r.textContent=`Round ${e+1}`)}showGameStatus(n,e="info"){const t=document.getElementById("game-status");if(t){const a={info:"#666",success:"#28a745",warning:"#ffc107",error:"#dc3545"};t.innerHTML=`
    ...
    `}showTrialFeedbackInContainer(n,e,t="collaboration"){if(console.log(`📊 Showing trial feedback in container: ${n?"SUCCESS":"FAILURE"}`),!e){console.warn("No canvas container provided for trial feedback");return}t!=="single"&&t!=="collaboration"&&(console.warn('Invalid messageType. Must be "single" or "collaboration"'),t="collaboration");let a;n?a=`
      ...
      `;let r;t==="single"?r=n?"Goal reached!":"Time up!":t==="collaboration"&&(r=n?"Collaboration succeeded!":"Collaboration failed!");const s=document.createElement("div");s.innerHTML=`
      <div style="
        text-align: center;
    ...
    `,s.style.cssText=`
      ...
      align-items: center;
      justify-content: center;
    `,e.style.position="relative",e.appendChild(s),setTimeout(()=>{s.parentNode&&s.parentNode.removeChild(s)},2e3)}setupGameCanvasInContainer(n){if(console.log("🎨 Setting up game canvas in timeline container"),!n){console.error("No container provided for game canvas");return}this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null);const e=this.renderer.createCanvas();e.id="gameCanvas",n.innerHTML="",n.appendChild(e),this.gameCanvas=e;const t=()=>{this.renderer.applyResponsiveSizing(),this.lastGameState&&this.renderer.render(this.gameCanvas,this.lastGameState)};this.handleResize=()=>t(),window.addEventListener("resize",this.handleResize),setTimeout(t,0),this.setupKeyboardControls(),console.log("✅ Game canvas set up in timeline container")}showConnectionLostError(n,e){this.container.innerHTML=`
    ...
    `;const t=document.getElementById("retry-connection-btn");t&&e&&t.addEventListener("click",e)}showReconnectingMessage(n){this.showGameStatus(n,"info")}showSuccessMessage(n){this.showGameStatus(n,"success"),setTimeout(()=>{this.showGameStatus("")},3e3)}destroy(){this.keyboardHandler&&document.removeEventListener("keydown",this.keyboardHandler),this.eventHandlers.clear(),this.gameCanvas=null,this.keyboardHandler=null}}const j={gridSize:15,noise:0,gamma:.9,goalReward:30,stepCost:-1,softmaxBeta:3,proximityRewardWeight:.01,coordinationRewardWeight:.02,maxPolicyIterations:15,progressivePolicyBuilding:!0,policyBuildTimeout:10,debugMode:!1,useFastOptimalPolicy:!1,enablePolicyPrecalculation:!1,jointRLImplementation:"bfs"};var kn;try{(kn=i==null?void 0:i.game)!=null&&kn.matrixSize&&(j.gridSize=i.game.matrixSize)}catch{}function ln(P){return P.map(n=>`${n[0]},${n[1]}`).sort().join("|")}function jn(P,n){if(!Array.isArray(P)||P.length===0)return[];if(P.some(o=>!isFinite(o)))return new Array(P.length).fill(1/P.length);const e=Math.max(...P),r=P.map(o=>n*(o-e)).map(o=>Math.max(-700,Math.min(700,o))).map(o=>Math.exp(o)),s=r.reduce((o,l)=>o+l,0)||1;return r.map(o=>o/s)}class Bn{constructor(n,e){this.nx=n,this.ny=e,this.coordinates=[];for(let t=0;t<n;t++)for(let a=0;a<e;a++)this.coordinates.push([t,a]);this.terminals=[],this.obstacles=[],this.features={}}addTerminals(n){this.terminals.push(...n)}addObstacles(n){this.obstacles.push(...n)}addFeatureMap(n,e,t=0){this.features[n]={};for(const a of this.coordinates)this.features[n][a.toString()]=t;for(const a in e)this.features[n][a.toString()]=e[a]}isStateValid([n,e]){return n<0||n>=this.nx||e<0||e>=this.ny?!1:!this.obstacles.some(t=>t[0]===n&&t[1]===e)}reward(n,e,t,a=null){return a?Object.keys(a).reduce((r,s)=>r+this.features[s][t.toString()]*a[s],0):Object.keys(this.features).reduce((r,s)=>r+this.features[s][t.toString()],0)}}function vn(P,n){return[P[0]+n[0],P[1]+n[1]]}class Fn{constructor(n,e,t,a){this.noise=n,this.noiseActionSpace=e,this.terminals=t,this.isStateValid=a}call(n,e){if(this.terminals.some(o=>o[0]===n[0]&&o[1]===n[1]))return{[n.toString()]:1};const t=vn(n,e);if(!this.isStateValid(t))return{[n.toString()]:1};const a=this.noiseActionSpace.map(o=>vn(n,o)).filter(this.isStateValid),r=this.noise/(a.length-1||1),s={};for(const o of a)s[o.toString()]=r;return s[t.toString()]=1-this.noise,s}}class Nn{constructor(n,e=.001,t=100,a=[]){this.gamma=n,this.epsilon=e,this.maxIter=t,this.terminals=a.map(r=>r.toString())}run(n,e,t,a){const r={};for(const s of n)r[s]=this.terminals.includes(s)?0:.1;for(let s=0;s<this.maxIter;s++){const o={...r};for(const c of n)this.terminals.includes(c)||(r[c]=Math.max(...e.map(h=>Object.entries(t[c][h]).reduce((d,[g,x])=>d+x*(a[c][h][g]+this.gamma*o[g]),0))));if(n.filter(c=>!this.terminals.includes(c)).map(c=>Math.abs(r[c]-o[c])).every(c=>c<this.epsilon))break}return r}}class qn{constructor(n,e,t,a,r,s,o){this.gridSize=n,this.actionSpace=e,this.noiseSpace=t,this.noise=a,this.gamma=r,this.goalReward=s,this.softmaxBeta=o}call(n,e){const t=new Bn(this.gridSize,this.gridSize);Array.isArray(n[0])||(n=[n]);const a={};for(const p of n)a[p.toString()]=this.goalReward;t.addFeatureMap("goal",a,0),t.addTerminals(n),t.addObstacles(e);const r=[];for(let p=0;p<t.nx;p++)for(let m=0;m<t.ny;m++){const u=[p,m];t.isStateValid(u)&&r.push(u.toString())}const s=new Fn(this.noise,this.noiseSpace,n,t.isStateValid.bind(t)),o={};for(const p of r){o[p]={};for(const m of this.actionSpace)o[p][m.toString()]=s.call(p.split(",").map(Number),m)}const l=j.stepCost,c={};for(const p of r){c[p]={};for(const m of this.actionSpace){c[p][m.toString()]={};const u=p.split(",").map(Number);for(const T of r){const G=T.split(",").map(Number),y=n.some(f=>f.toString()===T)?l+t.reward(G,m,G):l+t.reward(u,m,u);c[p][m.toString()][T]=y}}}const d=new Nn(this.gamma,.001,100,n).run(r,this.actionSpace.map(p=>p.toString()),o,c);for(const p of n)d[p.toString()]=this.goalReward;const g={};for(const p of r){g[p]={};for(const m of this.actionSpace.map(u=>u.toString()))g[p][m]=Object.entries(o[p][m]).reduce((u,[T,G])=>u+G*(c[p][m][T]+this.gamma*d[T]),0)}const x=new Un(g,this.softmaxBeta);return{Q_dict:g,policy:x}}}class Un{constructor(n,e=1){this.Q=n,this.beta=e}call(n){const e=n.toString(),t=Object.keys(this.Q[e]||{}),a=t.map(s=>this.Q[e][s]),r=jn(a,this.beta);return Object.fromEntries(t.map((s,o)=>[s,r[o]]))}}function On(P){const n=Object.keys(P),e=Object.values(P),t=Math.max(...e),a=n.filter((s,o)=>e[o]===t);return a[Math.floor(Math.random()*a.length)].split(",").map(Number)}const Sn=(()=>{const t=[[0,-1],[0,1],[-1,0],[1,0]],a=(m,u)=>m*15+u,r=m=>Math.floor(m/15),s=m=>m%15,o=(m,u)=>m>=0&&m<15&&u>=0&&u<15;function l(m,u){const T=r(m),G=s(m),[y,f]=t[u],b=T+y,v=G+f;return o(b,v)?a(b,v):m}function c(m,u,T=null){const G=r(m),y=s(m);let f=u[0],b=1/0;for(let M=0;M<u.length;M++){const S=u[M],A=Math.abs(G-S[0])+Math.abs(y-S[1]);let D;if(T!==null){const k=r(T),C=s(T),_=Math.abs(k-S[0])+Math.abs(C-S[1]);D=A+_}else D=A;D<b&&(f=S,b=D)}let v=G,w=y;return G!==f[0]?v+=f[0]<G?-1:1:y!==f[1]&&(w+=f[1]<y?-1:1),a(v,w)}const h=new Map;function d(m,u=1){const T=new Set(m.map(([k,C])=>a(k,C))),G=225*225,y=new Float32Array(G),f=new Float32Array(G*4),b=j.goalReward,v=j.stepCost,w=j.gamma;y.fill(-1e3);for(let k=0;k<G;k++){const C=Math.floor(k/225),_=k%225,H=T.has(C),U=T.has(_);if(H&&U&&C===_){y[k]=0;for(let L=0;L<4;L++)f[k*4+L]=0}}let M,S=0;const A=1e3,D=1e-6;do{M=0,S++;for(let k=0;k<G;k++){const C=Math.floor(k/225),_=k%225,H=T.has(C),U=T.has(_);if(H&&U&&C===_){y[k]=0;for(let B=0;B<4;B++)f[k*4+B]=0;continue}let L=-1/0;for(let B=0;B<4;B++){const O=H?C:l(C,B),W=c(_,m,O),R=T.has(O),Q=T.has(W),nn=R&&Q&&O===W;let K=v;nn?K=b:R&&Q&&O!==W?K=v*.5:(R||Q)&&(K=v*.8);const z=O*225+W,F=K+(nn?0:w*y[z]);f[k*4+B]=F,F>L&&(L=F)}const E=Math.abs(L-y[k]);E>M&&(M=E),y[k]=L}if(S>A){console.warn(`Joint RL VI did not converge after ${A} iters Δ=${M}`);break}}while(M>D);return{Q:f,goalSet:T,beta:u}}function g(m,u,T,G=null){G==null&&(G=j.softmaxBeta);const y=ln(T)+"|"+G;h.has(y)||h.set(y,d(T,G));const{Q:f,goalSet:b}=h.get(y),v=(R,Q)=>R*15+Q,w=v(m[0],m[1]),M=v(u[0],u[1]),S=b.has(w),A=b.has(M);if(S&&A&&w===M)return null;const C=(w*225+M)*4,_=[f[C],f[C+1],f[C+2],f[C+3]];if(_.some(R=>!isFinite(R)))return t[Math.floor(Math.random()*t.length)];if(G>10){const R=Math.max(..._),Q=_.map((nn,K)=>({q:nn,i:K})).filter(nn=>nn.q===R);return t[Q[Math.floor(Math.random()*Q.length)].i]}const H=Math.max(..._),L=_.map(R=>G*(R-H)).map(R=>Math.max(-700,Math.min(700,R))).map(R=>Math.exp(R)),E=L.reduce((R,Q)=>R+Q,0);if(!isFinite(E)||E===0){const R=_.indexOf(H);return t[R]}const B=Math.random()*E;let O=0;for(let R=0;R<L.length;R++)if(O+=L[R],B<O)return t[R];const W=_.indexOf(H);return t[W]}function x(m){const u=j.softmaxBeta,T=ln(m)+"|"+u;h.has(T)||h.set(T,d(m,u))}function p(){h.clear()}return{getAction:g,precalc:x,clear:p}})(),wn=(()=>{const P=j.gridSize||15,n=j.gridSize||15,e=P*n,t=[[0,-1],[0,1],[-1,0],[1,0]],a=(p,m)=>p*n+m,r=p=>Math.floor(p/n),s=p=>p%n,o=(p,m)=>p>=0&&p<P&&m>=0&&m<n,l=(p,m)=>{const u=r(p),T=s(p),G=u+t[m][0],y=T+t[m][1];return o(G,y)?a(G,y):p},c=new Map;function h(p,m=1){const u=new Set(p.map(([S,A])=>a(S,A))),T=e*e,G=new Float32Array(T*16),y=j.goalReward,f=j.stepCost,b=j.gamma,v=new Array(e);for(let S=0;S<e;S++){v[S]=new Array(p.length);const A=Math.floor(S/n),D=S%n;for(let k=0;k<p.length;k++){const[C,_]=p[k];v[S][k]=Math.abs(A-C)+Math.abs(D-_)}}const w=new Map;function M(S,A,D){if(D)return 0;const k=S<=A?`${S}-${A}`:`${A}-${S}`;if(w.has(k))return w.get(k);let C=1/0;for(let H=0;H<p.length;H++){const U=v[S][H]+v[A][H];U<C&&(C=U)}const _=-j.proximityRewardWeight*C;return w.set(k,_),_}for(let S=0;S<T;S++){const A=Math.floor(S/e),D=S%e;if(u.has(A)&&u.has(D)&&A===D){for(let k=0;k<16;k++)G[S*16+k]=0;continue}for(let k=0;k<4;k++){const C=u.has(A)?A:l(A,k);for(let _=0;_<4;_++){const H=u.has(D)?D:l(D,_),U=k*4+_,J=u.has(C)&&u.has(H)&&C===H,L=M(C,H,J),E=J?y:f+L;let B=0;if(!J){let O=1/0;for(let W=0;W<p.length;W++){const R=v[C][W]+v[H][W];R<O&&(O=R)}B=b*(y+f*O)}G[S*16+U]=E+B}}}return{Q:G,goalSet:u,beta:m}}function d(p,m,u,T=null){T==null&&(T=j.softmaxBeta);const G=ln(u)+"|"+T;c.has(G)||c.set(G,h(u,T));const{Q:y,goalSet:f}=c.get(G),b=a(p[0],p[1]),v=a(m[0],m[1]);if(f.has(b)&&f.has(v)&&b===v)return null;const M=(b*e+v)*16,S=[y[M],y[M+1],y[M+2],y[M+3],y[M+4],y[M+5],y[M+6],y[M+7],y[M+8],y[M+9],y[M+10],y[M+11],y[M+12],y[M+13],y[M+14],y[M+15]],A=f.has(v),D=f.has(b);if(A&&!D)for(let E=0;E<16;E++)Math.floor(E/4)<4&&(S[E]*=.5);if(S.some(E=>!isFinite(E)))return t[Math.floor(Math.random()*t.length)];const k=Math.max(...S),H=S.map(E=>T*(E-k)).map(E=>Math.max(-700,Math.min(700,E))).map(E=>Math.exp(E)),U=H.reduce((E,B)=>E+B,0);if(!isFinite(U)||U===0)return t[Math.floor(Math.random()*t.length)];const J=Math.random()*U;let L=0;for(let E=0;E<16;E++)if(L+=H[E],J<L){const B=Math.floor(E/4);return t[B]}return t[0]}function g(p){const m=j.softmaxBeta,u=ln(p)+"|"+m;c.has(u)||c.set(u,h(p,m))}function x(){c.clear()}return{getAction:d,precalc:g,clear:x}})();class Mn{constructor(){this.isPreCalculating=!1}getAIAction(n,e,t,a=null){if(!t||t.length===0)return[0,0];try{if(a&&i.game.agent.type==="joint"){const s=(j.jointRLImplementation||"vi4").toLowerCase()==="bfs"?wn.getAction(e,a,t,j.softmaxBeta):Sn.getAction(e,a,t,j.softmaxBeta);return s===null?[0,0]:s}return this.getIndividualRLAction(e,t)}catch(r){return console.error("Error in RL agent:",r),[0,0]}}getIndividualRLAction(n,e){const t=[[0,-1],[0,1],[-1,0],[1,0]],a=[...t],r=[],s=new qn(j.gridSize,t,a,j.noise,j.gamma,j.goalReward,j.softmaxBeta),{policy:o}=s.call(e,r),l=o.call(n);return On(l)}precalculatePolicyForGoals(n,e){this.isPreCalculating||(this.isPreCalculating=!0,setTimeout(()=>{try{(j.jointRLImplementation||"vi4").toLowerCase()==="bfs"?wn.precalc(n):Sn.precalc(n)}finally{this.isPreCalculating=!1}},0))}enableAutoPolicyPrecalculation(){}resetNewGoalPreCalculationFlag(){}}class cn{constructor(){this.baseUrl=i.server.url||""}static guidanceFor(n){switch(n){case"2P2G":return"You will collaborate  with another player. Each round, you can win if both of you go to the same restaurant. You lose the round if you end up at different restaurants. For each round that you win, you earn an additional 10 points.";case"2P3G":return"You will collaborate  with another player. Each round, you can win if both of you go to the same restaurant. You lose the round if you end up at different restaurants. Note that some restaurants are already open when the round starts. Others may appear later. For each round that you win, you earn an additional 10 points.";case"1P2G":return"Single player: reach any open goal.";case"1P1G":return"Single player: reach the goal.";default:return"Choose the best single step to reach a valid goal."}}static buildRelativeInfo(n,e="player2"){const t=n[e],a=n.currentGoals||[];if(!t||a.length===0)return null;let r=null,s=1/0;for(const l of a){const c=Math.abs(l[0]-t[0])+Math.abs(l[1]-t[1]);c<s&&(s=c,r=l)}const o=r?{dRow:r[0]-t[0],dCol:r[1]-t[1]}:null;return{nearestGoal:r,manhattanDistance:s,deltaToNearest:o}}async getNextAction(n,e={}){var T,G,y,f,b,v,w,M;const t=n.experimentType,a=e.guidance||cn.guidanceFor(t),s=(Number(e.aiPlayerNumber)===1?1:2)===1?"player1":"player2",o=((G=(T=i==null?void 0:i.game)==null?void 0:T.agent)==null?void 0:G.gpt)||{},l=n.trialData||null,c=Math.max(0,Number((y=o==null?void 0:o.memory)==null?void 0:y.maxSteps)||0),h=Array.isArray(l==null?void 0:l.player1Trajectory)?l.player1Trajectory:[],d=Array.isArray(l==null?void 0:l.player2Trajectory)?l.player2Trajectory:[],g=S=>c>0?S.slice(-c):S,x={guidance:a,matrix:n.gridMatrix,currentPlayer:{label:s,pos:n[s]},goals:n.currentGoals,relativeInfo:cn.buildRelativeInfo(n,s),model:e.model||o.model||void 0,temperature:typeof e.temperature=="number"?e.temperature:typeof o.temperature=="number"?o.temperature:void 0,memory:{enabled:!!((f=o==null?void 0:o.memory)!=null&&f.enabled),maxSteps:c,trajectories:(b=o==null?void 0:o.memory)!=null&&b.enabled?{player1:g(h),player2:g(d)}:void 0}},p=`${this.baseUrl.replace(/\/$/,"")}/api/ai/gpt/action`,m=await fetch(p,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(x)});if(!m.ok){const S=await m.text();throw new Error(`GPT action request failed: ${m.status} ${S}`)}const u=await m.json();try{const S=u&&(u.model||u.modelUsed);if(S){const A=(M=(w=(v=i==null?void 0:i.game)==null?void 0:v.agent)==null?void 0:w.gpt)==null?void 0:M.model;(!A||String(A).trim()!==String(S).trim())&&(i.game.agent.gpt.model=String(S).trim())}}catch{}return u&&Object.prototype.hasOwnProperty.call(u,"inferredGoal")?{action:(u==null?void 0:u.action)||null,inferredGoal:(u==null?void 0:u.inferredGoal)??null,model:u==null?void 0:u.model}:(u==null?void 0:u.action)||null}}class sn{static generateRandomizedDistanceSequence(n){const e=[this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER2,this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER1,this.DISTANCE_CONDITIONS.EQUAL_TO_BOTH,this.DISTANCE_CONDITIONS.NO_NEW_GOAL],t=e.length,a=Math.floor(n/t),r=n%t,s=[];for(let o=0;o<t;o++)for(let l=0;l<a;l++)s.push(e[o]);for(let o=0;o<r;o++){const l=e[Math.floor(Math.random()*t)];s.push(l)}for(let o=s.length-1;o>0;o--){const l=Math.floor(Math.random()*(o+1));[s[o],s[l]]=[s[l],s[o]]}return s}static generateNewGoal1P2G(n,e,t,a){var G,y,f,b,v,w,M;if(!n||!e)return null;const r=i.oneP2G;if(!r||a===((G=r==null?void 0:r.distanceConditions)==null?void 0:G.NO_NEW_GOAL))return null;const s=I.calculateGridDistance(n,e),o=i.game.matrixSize,l=(y=r.goalConstraints)==null?void 0:y.minDistanceFromHuman,c=(f=r.goalConstraints)==null?void 0:f.maxDistanceFromHuman,h=(b=r.goalConstraints)==null?void 0:b.minDistanceBetweenGoals,d=(v=r.distanceConstraint)==null?void 0:v.closerThreshold,g=(w=r.distanceConstraint)==null?void 0:w.fartherThreshold,x=!!((M=r.distanceConstraint)!=null&&M.allowEqualDistance),p=(S,A)=>{if(Array.isArray(t)){for(const D of t)if(D[0]===S&&D[1]===A)return!0}return n[0]===S&&n[1]===A},m=S=>{var A,D,k;switch(a){case((A=r.distanceConditions)==null?void 0:A.CLOSER_TO_PLAYER1):return S<=s-d;case((D=r.distanceConditions)==null?void 0:D.FARTHER_TO_PLAYER1):return S>=s+g;case((k=r.distanceConditions)==null?void 0:k.EQUAL_TO_PLAYER1):return x;default:return!1}},u=[];for(let S=0;S<o;S++)for(let A=0;A<o;A++){if(p(S,A))continue;const D=[S,A],k=I.calculateGridDistance(n,D);k<l||k>c||I.calculateGridDistance(e,D)<h||m(k)&&u.push(D)}if(u.length===0)for(let S=0;S<o;S++)for(let A=0;A<o;A++){if(p(S,A))continue;const D=[S,A],k=I.calculateGridDistance(n,D);k>=1&&k<=Math.max(10,c)&&u.push(D)}if(u.length===0)return null;const T=u[Math.floor(Math.random()*u.length)];return{position:T,conditionType:a,distanceToPlayer1:I.calculateGridDistance(n,T)}}static checkNewGoalPresentation1P2G(n,e,t){if(!n||!e||!n.currentGoals||n.currentGoals.length!==2||e.newGoalPresented)return null;const a=e.player1CurrentGoal;if((Array.isArray(a)&&a.length>0?a[a.length-1]:null)===null)return null;const s=n.currentGoals[0],o=this.generateNewGoal1P2G(n.player1,s,n.currentGoals,t);return o?{position:o.position,conditionType:o.conditionType,distanceToPlayer1:o.distanceToPlayer1}:null}static generateNewGoal(n,e,t,a,r){if(r===this.DISTANCE_CONDITIONS.NO_NEW_GOAL||a===null||a>=t.length)return null;const s=t[a],o=I.calculateGridDistance(e,s),l=I.calculateGridDistance(n,s),c=o+l,h=[],d=i.game.matrixSize,g=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},x=Number.isFinite(g.minDistanceFromHuman)?g.minDistanceFromHuman:1,p=Number.isFinite(g.maxDistanceFromHuman)?g.maxDistanceFromHuman:1/0;for(let u=0;u<d;u++)for(let T=0;T<d;T++){const G=[u,T];if(this.isPositionOccupied(G,t,e,n))continue;const y=I.calculateGridDistance(e,G),f=I.calculateGridDistance(n,G),b=y+f;y<x||y>p||f<x||f>p||this.meetsDistanceCondition(r,y,f,o,l,b,c)&&h.push({position:G,conditionType:r,distanceToPlayer1:y,distanceToPlayer2:f,distanceSum:b})}if(h.length>0)return h[Math.floor(Math.random()*h.length)];const m=this.findRelaxedValidPositions(e,n,t,r);return m.length>0?m[Math.floor(Math.random()*m.length)]:null}static isPositionOccupied(n,e,t,a){const[r,s]=n;for(const o of e)if(o[0]===r&&o[1]===s)return!0;return t[0]===r&&t[1]===s||a[0]===r&&a[1]===s}static meetsDistanceCondition(n,e,t,a,r,s,o){const l=i&&i.twoP3G&&i.twoP3G.distanceConstraint||{},c=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},h=Number.isFinite(l.closerThreshold)?l.closerThreshold:1,d=!!l.allowEqualDistance,g=Number.isFinite(l.maxDistanceIncrease)?l.maxDistanceIncrease:0,p=!!c.maintainDistanceSum?s===o:s<=o+g;switch(n){case this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER2:return(d?t<=r-h:t<r-h)&&p;case this.DISTANCE_CONDITIONS.CLOSER_TO_PLAYER1:return(d?e<=a-h:e<a-h)&&p;case this.DISTANCE_CONDITIONS.EQUAL_TO_BOTH:{const m=Math.abs(e-a),u=Math.abs(t-r),T=Math.abs(t-e),G=d?1:0,y=d?1:0;return m<=G&&u<=G&&T<=G&&Math.abs(s-o)<=y}default:return!1}}static findRelaxedValidPositions(n,e,t,a){const r=[],s=i.game.matrixSize,o=i&&i.twoP3G&&i.twoP3G.distanceConstraint||{},l=i&&i.twoP3G&&i.twoP3G.goalConstraints||{},c=Number.isFinite(l.minDistanceFromHuman)?l.minDistanceFromHuman:2,h=Number.isFinite(l.maxDistanceFromHuman)?l.maxDistanceFromHuman:Number.isFinite(o.maxDistanceIncrease)?Math.max(10,2+o.maxDistanceIncrease):10;for(let d=0;d<s;d++)for(let g=0;g<s;g++){const x=[d,g];if(!this.isPositionOccupied(x,t,n,e)){const p=I.calculateGridDistance(n,x),m=I.calculateGridDistance(e,x);p>=c&&p<=h&&m>=c&&m<=h&&r.push({position:x,conditionType:a,distanceToPlayer1:p,distanceToPlayer2:m,distanceSum:p+m})}}return r}static checkNewGoalPresentation2P3G(n,e,t){const{player1:a,player2:r,currentGoals:s}=n;if(!a||!r||!s||s.length<2||e.newGoalPresented)return null;const o=this.getPlayerCurrentGoal(e.player1CurrentGoal),l=this.getPlayerCurrentGoal(e.player2CurrentGoal);if(o!==null&&l!==null&&o===l){console.log("=== SHARED GOAL DETECTED ==="),console.log("Player1 goal:",o,"Player2 goal:",l);const c=this.generateNewGoal(r,a,s,o,t);if(c)return console.log("=== NEW GOAL GENERATED ==="),console.log("New goal position:",c.position),console.log("Distance condition:",t),{position:c.position,conditionType:c.conditionType,distanceToPlayer1:c.distanceToPlayer1,distanceToPlayer2:c.distanceToPlayer2}}return null}static getPlayerCurrentGoal(n){return!n||n.length===0?null:n[n.length-1]}}fn(sn,"DISTANCE_CONDITIONS",{CLOSER_TO_PLAYER2:"closer_to_player2",CLOSER_TO_PLAYER1:"closer_to_player1",EQUAL_TO_BOTH:"equal_to_both",NO_NEW_GOAL:"no_new_goal"});const Vn=`var MapsFor1P1G = {
    "0": [
        {
            "initPlayerGrid": [
                7,
    ...
    `;const n=document.getElementById("welcomeVideo"),e=()=>{n&&(n.muted=!1,n.volume=1,n.play().catch(a=>{console.warn("Unable to start video with sound:",a)}),document.removeEventListener("click",e),document.removeEventListener("keydown",e),n.removeEventListener("click",e))};document.addEventListener("click",e,{once:!0}),document.addEventListener("keydown",e,{once:!0}),n&&n.addEventListener("click",e,{once:!0});const t=a=>{(a.code==="Space"||a.key===" ")&&(a.preventDefault(),a.stopPropagation(),document.removeEventListener("keydown",t,!0),console.log("🎮 Starting game sequence"),this.nextStage())};document.addEventListener("keydown",t,!0),document.body.focus()}showInstructionsStage(n,e){const t=this.getInstructionsForExperiment(n);if(this.container.innerHTML=t.html,n==="1P1G"||n==="1P2G"||n==="2P2G"||n==="2P3G"){const r=document.getElementById("game1Video")||document.getElementById("game2Video")||document.getElementById("game3Video")||document.getElementById("game4Video")||this.container.querySelector("video");r&&(r.autoplay=!0,r.playsInline=!0,(()=>(r.muted=!1,r.volume=1,r.play()))().catch(o=>{console.warn("Unable to autoplay instruction video with sound, falling back to muted:",o),r.muted=!0,r.play().catch(c=>{console.warn("Unable to autoplay muted instruction video:",c)});const l=()=>{r.muted=!1,r.volume=1,r.play().catch(c=>{console.warn("Unable to start instruction video with sound after interaction:",c)}),document.removeEventListener("click",l),document.removeEventListener("keydown",l),r.removeEventListener("click",l)};document.addEventListener("click",l,{once:!0}),document.addEventListener("keydown",l,{once:!0}),r.addEventListener("click",l,{once:!0})}))}const a=r=>{(r.code==="Space"||r.key===" ")&&(r.preventDefault(),r.stopPropagation(),document.removeEventListener("keydown",a,!0),console.log(`📋 Instructions completed for ${n}`),this.nextStage())};document.addEventListener("keydown",a,!0),document.body.focus()}showComprehensionCheckStage(n,e){const t=(a=!1)=>{this.container.innerHTML=`
      ...
      `;let r=null;const s=()=>{try{r&&(r.pause(),r.currentTime=0,r=null)}catch{}};(()=>{if(a)try{const h=new Audio(this.assetUrl("tryAgain.mp3"));r=h,h.play().catch(d=>{console.warn("Unable to autoplay tryAgain audio:",d)})}catch(h){console.warn("Error starting tryAgain audio:",h)}else try{const h=new Audio(this.assetUrl("comprehensionCheck.mp3"));r=h,h.play().catch(d=>{console.warn("Unable to autoplay comprehension audio:",d)})}catch(h){console.warn("Error starting comprehension audio:",h)}})();const l=document.getElementById("red-dot-btn"),c=document.getElementById("orange-dot-btn");l&&l.addEventListener("click",()=>{s(),console.log("✅ Comprehension check passed (red dot selected). Continuing to Game 3."),this.nextStage()}),c&&c.addEventListener("click",()=>{s(),console.log("⚠️ Comprehension check failed (purple dot selected). Showing error message."),t(!0)})};t(!1)}checkPartnerPresenceAndProceed(n,e){var a,r,s;console.log(`🔍 Checking partner presence for ${n} transition...`),((s=(r=(a=i==null?void 0:i.game)==null?void 0:a.players)==null?void 0:r.player2)==null?void 0:s.type)==="human"?(this.emit("check-partner-status",{experimentType:n,experimentIndex:e}),this.partnerStatusChecked=!1,this.shouldSkipMatchPlay=!1,setTimeout(()=>{var l,c,h;this.partnerStatusChecked||(console.log("⏰ Partner status check timeout - assuming partner disconnected"),this.shouldSkipMatchPlay=!0,this.partnerStatusChecked=!0),((h=(c=(l=i==null?void 0:i.game)==null?void 0:l.players)==null?void 0:c.player2)==null?void 0:h.type)==="human"&&!this.shouldSkipMatchPlay?(console.log("✅ Partner still connected, proceeding to match-play stage"),this.nextStage()):(console.log("🤖 Partner disconnected, switching to AI mode"),this.gameMode="human-ai",this.nextStage())},3e3)):(console.log("🤖 Already in AI mode, skipping match-play stage"),this.gameMode="human-ai",this.nextStage())}showWaitingForPartnerStage(n,e){var g,x,p,m,u,T,G;const t=(x=(g=i==null?void 0:i.game)==null?void 0:g.timing)==null?void 0:x.waitingForPartnerMinDuration,a=(m=(p=i==null?void 0:i.game)==null?void 0:p.timing)==null?void 0:m.waitingForPartnerMaxDuration,r=Date.now()+t;let s=!1;const o=Date.now();if(console.log("⏱️ [WAITING] Partner search started at:",new Date(o).toISOString()),this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
    ...
    `,!(((G=(T=(u=i==null?void 0:i.game)==null?void 0:u.players)==null?void 0:T.player2)==null?void 0:G.type)==="human")){this.gameMode="human-ai",setTimeout(()=>{this.nextStage()},Math.max(0,r-Date.now()));return}const c=y=>{var f;if(y.code==="Space"||y.key===" "){if(y.preventDefault(),Date.now()<r)return;const b=Date.now(),v=b-o;console.log("⏱️ [WAITING] Skipped after waiting duration:",v+"ms ("+(v/1e3).toFixed(1)+"s)"),this.recordWaitingTime(o,b,v,"skip",n,e),document.removeEventListener("keydown",c),console.log("⏭️ Skipping multiplayer waiting after min wait - continuing with AI partner");const w=((f=i==null?void 0:i.multiplayer)==null?void 0:f.fallbackAIType)||"rl_joint";q.setPlayerType(2,w);try{this.emit("fallback-to-ai",{reason:"waiting-skip",stage:"waiting-for-partner",at:Date.now(),fallbackAIType:w})}catch{}this.nextStage()}};document.addEventListener("keydown",c),this.emit("waiting-for-partner",{experimentType:n,experimentIndex:e});const h=document.getElementById("cancel-wait-btn");h&&(h.onclick=()=>{console.log("⚠️ Waiting canceled by user"),window.close()});const d=y=>{console.log("👥 Partner connected - will advance after minimum waiting time",y),this.gameMode="human-human",s=!0;const f=Date.now(),b=f-o;console.log("⏱️ [WAITING] Partner found! Waiting duration:",b+"ms ("+(b/1e3).toFixed(1)+"s)"),this.recordWaitingTime(o,f,b,"partner_found",n,e),document.removeEventListener("keydown",c),this.off("partner-connected",d);let v=r;if(y&&y.connectedAt){const M=y.connectedAt+t;v=Math.max(v,M)}const w=Math.max(0,v-Date.now());setTimeout(()=>this.nextStage(),w)};this.eventHandlers.delete("partner-connected"),this.on("partner-connected",d),setTimeout(()=>{var y,f;if(!s){const b=Date.now(),v=b-o;console.log("⏱️ [WAITING] Timeout after waiting duration:",v+"ms ("+(v/1e3).toFixed(1)+"s)"),this.recordWaitingTime(o,b,v,"timeout",n,e),console.log(`⌛ No partner found after ${a}ms - falling back to AI mode`);const w=((y=i==null?void 0:i.multiplayer)==null?void 0:y.fallbackAIType)||"rl_joint";q.setPlayerType(2,w),this.gameMode="human-ai",document.removeEventListener("keydown",c);try{this.emit("fallback-to-ai",{reason:"waiting-timeout",stage:"waiting-for-partner",at:Date.now(),fallbackAIType:w})}catch{}try{(f=i==null?void 0:i.debug)!=null&&f.disableConsoleLogs||console.log("[DEBUG] Timeline emitting ai-fallback-activated event (waiting timeout)")}catch{}this.emit("ai-fallback-activated",{fallbackType:w,aiPlayerNumber:2}),this.nextStage()}},a)}showReadyToPlayStage(n,e){if(this.isHumanHumanMode()&&i.game.players.player2.type==="human"){this.container.innerHTML=`
        <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
    ...
    `,this.emit("show-fixation",{experimentType:n,experimentIndex:e,trialIndex:t});const a=s=>{(s.code==="Space"||s.key===" ")&&(s.preventDefault(),document.removeEventListener("keydown",a),console.log("⏭️ Fixation skipped by user"),this.nextStage())};document.addEventListener("keydown",a),console.log(`⏰ Setting fixation timeout for ${i.game.timing.fixationDuration}ms`);const r=setTimeout(()=>{document.removeEventListener("keydown",a),console.log(`⚡ Fixation completed for trial ${t} - advancing to next stage`),this.nextStage()},i.game.timing.fixationDuration);this.currentFixationTimeout=r}runTrialStage(n,e,t){var o,l,c;console.log(`🎮 Starting trial ${t} of ${n}`);let a=i.visual.colors.player1,r="Player 1 (Red)";n.includes("2P")&&(a=this.playerIndex===0?i.visual.colors.player1:i.visual.colors.player2,r=this.playerIndex===0?"Player 1 (Red)":"Player 2 (Orange)");const s=((c=(l=(o=i==null?void 0:i.game)==null?void 0:o.experiments)==null?void 0:l.numTrials)==null?void 0:c[n])||1;this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
        <div style="text-align: center; max-width: 800px; width: 100%;">
          <h3 style="margin-bottom: 20px;">Game ${e+1}</h3>
          <h4 style="margin: -8px 0 16px 0; color: #4b5563;">Round ${t+1}/${s}</h4>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 20px;">
              ...
              ${s?`
                <div style="background: white; padding: 20px; border-radius: 8px; border-left: 4px solid #ffc107;">
                  ...
                  <p style="font-size: 24px; font-weight: bold; color: #333; margin: 0;">${o}%</p>
    ...
    `,this.stages.some(d=>d.type==="questionnaire")||this.stages.push({type:"questionnaire",handler:()=>this.showQuestionnaireStage()});const h=document.getElementById("continueToQuestionnaireBtn");h&&h.addEventListener("click",()=>{console.log("🎮 Game Feedback Stage: Continue button clicked"),this.nextStage()})}showQuestionnaireStage(){const n=()=>{const a=[{name:"ai_detection",title:"Page 1 of 3",prompt:"Do you think the other player is a person or a computer?",options:["Person","Computer"],optionImages:["person.png","computer.png"]},{name:"collaboration_rating",title:"Page 2 of 3",prompt:"How well did the other player collaborate with you?",options:["Good collaborator","Bad collaborator"],optionImages:["good.png","bad.png"]},{name:"play_again",title:"Page 3 of 3",prompt:"Would you like to play this game again in the future?",options:["Yes","No"],optionImages:["yes.png","no.png"]}],r={};let s=0,o=0,l=null;const c=window.speechSynthesis||null,h=async(p=!0)=>{const m=s+1,u=this.assetUrl(`question${m}.mp3`);return p&&(c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null)),new Promise(T=>{const G=new Audio(u);G.onloadeddata=()=>{l=G,G.play().then(()=>{G.onended=()=>{l=null,T()},G.onerror=()=>{l=null,console.warn("Questionnaire prompt audio playback failed:",u),T()}}).catch(()=>T())},G.onerror=()=>{console.warn("Questionnaire prompt audio missing or failed to load:",u),T()},G.load()})},d=(p=!1)=>{const m=a[s],u=m.optionImages||[],T=m.options.map((y,f)=>{const b=f===o,v=b?"#4f46e5":"#e5e7eb",w=b?"#eef2ff":"#ffffff",M=u[f]?this.assetUrl(u[f]):"";return`
          ...
          </div>`,p&&h(!0),this.container.querySelectorAll(".image-option").forEach(y=>{y.addEventListener("click",()=>{o=Number(y.getAttribute("data-idx")||"0"),r[m.name]=m.options[o],c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),s<a.length-1?(s+=1,o=0,d(!0)):(document.removeEventListener("keydown",g),this.experimentData.questionnaire=r,console.log("📝 Questionnaire completed"),this.nextStage())})})},g=p=>{const m=p.code==="ArrowUp"||p.key==="ArrowUp"||p.code==="ArrowLeft"||p.key==="ArrowLeft",u=p.code==="ArrowDown"||p.key==="ArrowDown"||p.code==="ArrowRight"||p.key==="ArrowRight";m?(p.preventDefault(),o=Math.max(0,o-1),d(!1)):u?(p.preventDefault(),o=Math.min(a[s].options.length-1,o+1),d(!1)):(p.code==="Space"||p.key===" ")&&(p.preventDefault(),c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),r[a[s].name]=a[s].options[o],s<a.length-1?(s+=1,o=0,d(!0)):(document.removeEventListener("keydown",g),c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),this.experimentData.questionnaire=r,console.log("📝 Questionnaire completed"),this.nextStage()))};d(!0),document.addEventListener("keydown",g);const x=()=>{c&&c.cancel(),l&&(l.pause(),l.currentTime=0,l=null),document.removeEventListener("keydown",g)};this._questionnaireCleanup=x};this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
        <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 800px; text-align: center;">
    ...
    `;const e=document.getElementById("questionnaireInstructionsVideo");e&&(e.autoplay=!0,e.playsInline=!0,(()=>(e.muted=!1,e.volume=1,e.play()))().catch(r=>{console.warn("Unable to autoplay questionnaire video with sound, falling back to muted:",r),e.muted=!0,e.play().catch(o=>{console.warn("Unable to autoplay muted questionnaire video:",o)});const s=()=>{try{e.muted=!1,e.volume=1,e.play().catch(o=>{console.warn("Unable to start questionnaire video with sound after interaction:",o)})}catch{}document.removeEventListener("click",s),document.removeEventListener("keydown",s),e.removeEventListener("click",s)};document.addEventListener("click",s,{once:!0}),document.addEventListener("keydown",s,{once:!0}),e.addEventListener("click",s,{once:!0})}));const t=a=>{(a.code==="Space"||a.key===" ")&&(a.preventDefault(),a.stopPropagation(),document.removeEventListener("keydown",t,!0),n())};document.addEventListener("keydown",t,!0),document.body.focus()}showEndExperimentInfoStage(){var r,s;const n=this.generateCompletionCode(),e=()=>{if(!this._lookitDonePosted){this._lookitDonePosted=!0;try{window.parent.postMessage({type:"exp-lookit:next"},"*")}catch(o){console.warn("Unable to post exp-lookit:next message:",o)}}};this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
        <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 600px; text-align: center;">
    ...
    `,this.experimentData.completed=!0,this.experimentData.completionCode=n,this.experimentData.endTime=new Date().toISOString(),this.emit("save-data",this.experimentData);const t=document.getElementById("continueBtn");try{(r=i==null?void 0:i.server)!=null&&r.enableGoogleDriveSave&&t&&(t.disabled=!0,t.style.opacity="0.6",t.style.cursor="not-allowed",t.textContent="Saving...")}catch{}try{(s=i==null?void 0:i.server)!=null&&s.enableGoogleDriveSave&&setTimeout(()=>{const o=document.getElementById("saving-status"),l=document.getElementById("continueBtn");o&&l&&l.disabled&&(o.textContent="⚠️ Save taking longer than expected. You may continue.",o.style.color="#dc3545",l.disabled=!1,l.style.opacity="1",l.style.cursor="pointer",l.textContent="Continue")},15e3)}catch{}const a=()=>{const o=document.getElementById("saving-status");o&&(o.textContent="✅ Data saved successfully!",o.style.color="#28a745"),t&&(t.disabled=!1,t.style.opacity="1",t.style.cursor="pointer",t.textContent="Continue"),this.off("data-save-success",a),e(),this.nextStage()};this.eventHandlers.delete("data-save-success"),this.on("data-save-success",a),document.getElementById("continueBtn").addEventListener("click",()=>{if(console.log("💾 Data saving initiated"),t&&t.disabled){console.log("⏳ Waiting for data-save success before continuing");return}e(),this.nextStage()})}showProlificRedirectStage(){var e;const n=((e=i==null?void 0:i.game)==null?void 0:e.prolificCompletionCode)||this.experimentData.completionCode||"CTNDR8GV";this.container.innerHTML=`
      <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
        <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 600px; text-align: center;">
    ...
    `;try{const t=document.getElementById("copyCodeBtn"),a=document.getElementById("completionCodeText"),r=document.getElementById("copyStatus");t&&a&&t.addEventListener("click",async()=>{const s=(a.textContent||"").trim();try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(s);else{const o=document.createElement("textarea");o.value=s,document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o)}r&&(r.style.display="inline",t.textContent="Copied!",t.style.background="#28a745",setTimeout(()=>{r.style.display="none",t.textContent="Copy Code",t.style.background="#007bff"},2e3))}catch(o){console.warn("Copy failed:",o)}})}catch{}}isHumanHumanMode(){return this.gameMode==="human-human"||q&&typeof q.isHumanHumanMode=="function"&&q.isHumanHumanMode()?!0:new URLSearchParams(window.location.search).get("mode")==="human-human"}assetUrl(n){const e="/MinimalCoordinationGame-CHS-unmoderated/",t=String(n||"").replace(/^\/+/,"");return`${e}${t}`}getInstructionsForExperiment(n){var a;return{"1P1G":{html:`
          <div style="display: flex; align-items: center; justify-content: center; min-height: 100vh; background: #f8f9fa;">
            <div style="background: white; padding: 40px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 800px; text-align: center;">
