...
export class GameRoomManager {
  ...
  joinRoom(playerId, roomId = null, gameMode = 'human-ai', experimentType = '2P2G') {
    ...
    if (roomId) {
      ...
      if (room.experimentType !== experimentType) {
        throw new Error(`Room experiment mismatch: expected ${room.experimentType}, got ${experimentType}`);
      }
    } else {
  ...
  findAvailableRoom(gameMode, experimentType) {
